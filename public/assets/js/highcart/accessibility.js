      ...
      (() => {
                ...
                ? e.options.accessibility.typeDescription ||
                    (function (e, t) {
                      ...
                      return i
                        ...
                        : e.langFormat('accessibility.chartTypes.emptyChart', r)
                    })(e, e.types)
                : ''
            }
        ...
        !(function (e) {
          function t (e) {
            ...
            if (s) {
              ...
              return (
                r && r.element && o && this.setFocusToElement(r, o),
                tn(!0, s),
                !0
              )
            }
        ...
        class ic {
          ...
          render () {
            ...
            this.track.attr({ x: -ii(0, r), y: -ii(0, r) }),
        ...
        class iI {
            ...
            this.handles[t][s](
              i
                ? {
                    ...
                    translateY: Math.round(this.top + parseInt(e, 10) + 0.5 - n)
                  }
                : {
              ...
              ;[0, 1].forEach(t => {
                ...
                if (e.handles[t] && e.handles[t].symbolUrl === h) {
                  if (!e.handles[t].isImg && e.handles[t].symbolName !== h) {
                    let i = im[h].call(im, -l / 2 - 1, 0, l, n)
          ...
          render (e, t, i, s) {
            ...
            if (
              ...
              if (!h) return
              ;(i = 0), (s = iP(r.width, a.width))
            }
            this.left = iP(r.left, n.plotLeft + p + (c ? n.plotWidth : 0))
            let v =
              (this.size =
              x =
                iP(r.len, (c ? n.plotHeight : n.plotWidth) - 2 * p))
            ;(g = c ? f : x + 2 * p),
              (i = iP(i, r.toPixels(e, !0))),
              (s = iP(s, r.toPixels(t, !0))),
          ...
          addMouseEvents () {
            ...
            ;(e.mouseMoveHandler = n =
              ...
              (s = e.getPartsEvents('mousedown')).push(
                ib(t.renderTo, 'mousemove', n),
                ib(i.ownerDocument, 'mouseup', r),
                ib(t.renderTo, 'touchmove', n),
                ib(i.ownerDocument, 'touchend', r)
              ),
              ...
              (h.xAxis = {
                ...
                translate: function (t, i) {
                  let s = e.xAxis[0],
                    n = s.getExtremes(),
                    r = s.len - 2 * l,
                    o = iB('min', s.options.min, n.dataMin),
                    a = iB('max', s.options.max, n.dataMax) - o
            ...
            return (
              (e && null === i.dataMin) ||
                (t = {
                  dataMin: iP(
                    s.parse(r?.min),
                    iB('min', s.parse(o.min), i.dataMin, n.dataMin, n.min)
                  ),
                  dataMax: iP(
                    s.parse(r?.max),
                    iB('max', s.parse(o.max), i.dataMax, n.dataMax, n.max)
                  )
                }),
              t
            )
          ...
          shouldStickToMin (e, t) {
            let i = t.getBaseSeriesMin(e.getColumn('x')[0]),
              ...
              r = s.min,
              o = s.options.range
            return !!(ik(n) && ik(r)) && (o && n - i > 0 ? n - i < o : r <= i)
          }
          addChartEvents () {
        ...
        let { animObject: iF } = w(),
                ...
                ;[0, 1].forEach(t => {
                  ...
                  if (i) {
                    let s = this.proxyProvider.addProxyElement(
                      ...
                      {
                        type: 'range',
                        'aria-label': iO(n, { handleIx: t, chart: e }, e)
                      }
                    )
          ...
          { format: ij, numberFormat: i_ } = D(),
          { reverseChildNodes: iZ, stripHTMLTagsFromString: i$ } = S,
        ...
        let i8 = {
                                ...
                                let i = e.series,
                                  ...
                                  r = i$(
                                    (i0(s.descriptionFormat) &&
                                      ...
                                      (i0(n.descriptionFormat) &&
                                        ij(n.descriptionFormat, e, i.chart)) ||
          ...
          { getChartTitle: ss } = K,
          {
            defaultPointDescriptionFormatter: sn,
            defaultSeriesDescriptionFormatter: sr
          } = i8
        function so (e) {
        ...
        class sa {
          ...
          buildAnnouncementMessage (e, t, i) {
            ...
            return s.langFormat('accessibility.announceNewData.' + o, {
              chartTitle: a,
              seriesDesc: t ? sr(t) : null,
              pointDesc: i ? sn(i) : null,
              point: i,
              series: t
            })
          }
        ...
        !(function (e) {
          ...
          e.compose = function (e) {
            si(i7, 'A11y.NDA') &&
              (se(e, 'addPoint', t), se(e, 'updatedData', i))
          }
        })(sa || (sa = {}))
        let sl = sa,
          { doc: sh } = w(),
          ...
          sx = class {
            constructor (e, t, i = 'button', s, n) {
              ;(this.chart = e),
                (this.target = t),
                (this.eventProvider = new Y())
              let r = (this.innerElement = sh.createElement(i)),
                o = (this.element = s ? sh.createElement(s) : r)
        ...
        class sP extends Z {
          ...
          updateSelectorVisibility () {
            ...
            t && t.hasVisibleDropdown && i
              ? (sC(e, i), s.forEach(e => n(e.element)))
              : (i && n(i), s.forEach(t => sC(e, t.element)))
          }
          setDropdownAttrs () {
            let e = this.chart,
        ...
        !(function (e) {
          ...
          e.compose = function (e, s) {
            ...
            n.highlightRangeSelectorButton ||
              ((n.highlightRangeSelectorButton = t), sk(s, 'afterBtnClick', i))
          }
        })(sP || (sP = {}))
        let sD = sP,
          { composed: sN } = w(),
        ...
        function s_ (e) {
          let t = e.series.chart.options.accessibility,
            i =
              e.options.accessibility && !1 === e.options.accessibility.enabled
          return (
            (e.isNull &&
          ...
          for (let e = 0; e < i; ++e)
            if (!sj(t[e])) {
              let i = (function (e) {
                let t = e.points || [],
                  i = t.length
                for (let e = 0; e < i; ++e) if (!s_(t[e])) return t[e]
                return null
              })(t[e])
              if (i) return i
            }
            ...
            return new Q(i, {
              keyCodeMap: [
                ...
                [
                  [t.end],
                  function () {
                    return s$(i), this.response.success
                  }
                ],
                [
                  [t.pageDown, t.pageUp],
        ...
        !(function (e) {
          ...
          function r () {
            let e = this.chart.highlightedPoint,
              ...
              s = i.length
            if (i && s) {
              for (let e = t; e < s; ++e) if (!s_(i[e])) return i[e].highlight()
              for (let e = t; e >= 0; --e)
                if (!s_(i[e])) return i[e].highlight()
            }
            return !1
          }
        ...
        let s0 = sJ,
              ...
              return new Q(r, {
                keyCodeMap: [
                  ...
                  [
                    [s.space, s.enter],
                    function () {
                      return s9(i(this, r), this.response.success)
                    }
                  ]
                ],
                validate: function () {
          ...
          { doc: s7, isMS: ne, win: nt } = w(),
          ni = {
            isHighContrastModeActive: function () {
              let e = /(Edg)/.test(nt.navigator.userAgent)
              if (nt.matchMedia && e)
                return nt.matchMedia('(-ms-high-contrast: active)').matches
              if (ne && nt.getComputedStyle) {
                let e = s7.createElement('div')
                ;(e.style.backgroundImage =
                  'url(data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==)'),
                  s7.body.appendChild(e)
                let t = (e.currentStyle || nt.getComputedStyle(e))
                  .backgroundImage
                return s7.body.removeChild(e), 'none' === t
              }
              return (
                nt.matchMedia &&
                nt.matchMedia('(forced-colors: active)').matches
              )
            },
        ...
        function nr (e, t, i) {
          let s = e,
            n,
            r = 0
          for (; r < t.length - 1; ++r) s = s[(n = t[r])] = nn(s[n], {})
          s[t[t.length - 1]] = i
        }
        function no (e, t, i, s) {
          function n (e, t) {
        ...
        let na = function (e) {
            !(function (e) {
              ...
              ;['description', 'typeDescription'].forEach(function (s) {
                t[s] &&
                  ((i[s] = t[s]),
                  ns(32, !1, e, { [`chart.${s}`]: `use accessibility.${s}` }))
              })
            })(e),
              (function (e) {
              ...
              no(e, ['accessibility'], ['accessibility'], {
              ...
              no(e, ['lang', 'accessibility'], ['lang', 'accessibility'], {
          ...
          { defaultOptions: nl } = w(),
          { doc: nh } = w(),
          { addEvent: nc, extend: nd, fireEvent: nu, merge: np } = w(),
          { removeElement: ng } = S
        class nm {
          constructor (e) {
            this.init(e)
          ...
          init (e) {
            if (((this.chart = e), !nh.addEventListener)) {
              ;(this.zombie = !0),
                (this.components = {}),
          ...
          initComponents () {
            ...
            ;(this.components = {
              ...
              i.customComponents && nd(this.components, i.customComponents)
          ...
          update () {
            let e = this.components,
              t = this.chart,
              i = t.options.accessibility
            nu(t, 'beforeA11yUpdate'), (t.types = this.getChartTypes())
            let s = i.keyboardNavigation.order
            this.proxyProvider.updateGroupOrder(s),
              this.getComponentOrder().forEach(function (i) {
                e[i].onChartUpdate(),
                  nu(t, 'afterA11yComponentUpdate', {
                    name: i,
                    component: e[i]
                  })
              }),
              ...
              !t.highContrastModeActive &&
                ...
                (ni.isHighContrastModeActive() || !0 === i.highContrastMode) &&
                ni.setHighContrastTheme(t),
              nu(t, 'afterA11yUpdate', { accessibility: this })
          }
          destroy () {
            let e = this.chart || {},
              t = this.components
            Object.keys(t).forEach(function (e) {
              ...
              e.announcerContainer && ng(e.announcerContainer),
        ...
        !(function (e) {
          ...
          function s (e) {
            ...
            t &&
              ...
              np(!0, this.options.accessibility, t),
              this.accessibility &&
        ...
        let nb = nm,
          nf = w()
        ;(nf.i18nFormat = nb.i18nFormat),
          (nf.A11yChartUtilities = K),
          (nf.A11yHTMLUtilities = S),
          (nf.AccessibilityComponent = Z),
          (nf.KeyboardNavigationHandler = Q),
          (nf.SeriesAccessibilityDescriber = i8),
          nb.compose(
            nf.Chart,
            nf.Legend,
            nf.Point,
