      ...
      !(function (e) {
        ...
        function r (e) {
          ...
          s
            ...
            r.text && r.symbol
              ...
              : r.text || W(c, { width: r.width, height: r.height, padding: 0 })
          let p = o
            .button(
              r.text,
              0,
        ...
        function b (e) {
          ...
          this.axes.forEach(function (e) {
            e.userOptions.internalKey || (e.userOptions.internalKey = A()),
        ...
        e.compose = function (e, n) {
          ...
          i.exportChart ||
            ...
            N(e, 'layOutTitle', T),
            h().isSafari &&
              H.matchMedia('print').addListener(function (e) {
                t && (e.matches ? t.beforePrint() : t.afterPrint())
              }),
            (P.exporting = V(m.exporting, P.exporting)),
            (P.lang = V(m.lang, P.lang)),
            (P.navigation = V(m.navigation, P.navigation)))
        }
      })(r || (r = {}))
      let K = r,
        B = h()
      ;(B.HttpUtilities = B.HttpUtilities || F),
        (B.ajax = B.HttpUtilities.ajax),
        (B.getJSON = B.HttpUtilities.getJSON),
        (B.post = B.HttpUtilities.post),
        K.compose(B.Chart, B.Renderer)
      let J = h()
      return c.default
    })()
  )
