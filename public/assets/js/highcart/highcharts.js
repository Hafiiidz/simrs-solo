!(
 ...
 - ${i}: ${e}`),
      ...
      let $ = {
        ...
        ta =
          k.isSafari && V.Intl && !V.Intl.DateTimeFormat.prototype.formatRange,
        tn = t => void 0 === t.main,
        th = t => ['D', 'L', 'M', 'X', 'J', 'V', 'S'].indexOf(t),
        tl = class {
          constructor (t) {
            ;(this.options = {}),
          ...
          update (t = {}) {
            ...
            let { timezoneOffset: i, useUTC: s } = t
            ;(this.Date = t.Date || V.Date || Date),
              q(s) && (e = s ? 'UTC' : void 0),
              i && i % 60 == 0 && (e = 'Etc/GMT' + (i > 0 ? '+' : '') + i / 60),
              (this.variableTimezone =
                'UTC' !== e && e?.indexOf('Etc/GMT') !== 0),
              (this.timezone = e),
          ...
          parse (t) {
            ...
            e || i || (t += 'Z')
            let s = Date.parse(t)
            if (K(s)) return s + (!e || i ? this.getTimezoneOffset(s) : 0)
          }
          getTimezoneOffset (t) {
            if ('UTC' !== this.timezone) {
          ...
          dateFormat (t, e, i) {
            ...
            if (Q(t) && -1 !== t.indexOf('%')) {
              ...
              let i = (this.getTimezoneOffset(e) || 0) / 36e5,
                s =
                  this.options.timezone || 'Etc/GMT' + (i >= 0 ? '+' : '') + i,
                { prefix: o = '', suffix: r = '' } = t
          ...
          getTimeTicks (t, e, i, s) {
            ...
            if ((s ?? (s = 1), q(e))) {
              if (
                ((f = h >= to.second ? 0 : n * Math.floor(f / n)),
                h >= to.second &&
                  (g = h >= to.minute ? 0 : n * Math.floor(g / n)),
                h >= to.minute &&
                  (u = h >= to.hour ? 0 : n * Math.floor(u / n)),
                h >= to.hour && (p = h >= to.day ? 0 : n * Math.floor(p / n)),
                h >= to.day &&
                  (c = h >= to.month ? 1 : Math.max(1, n * Math.floor(c / n))),
                h >= to.month && (d = h >= to.year ? 0 : n * Math.floor(d / n)),
                h >= to.year && (l -= l % n),
                h === to.week)
              ) {
              ...
              for (; t < i; )
                r.push(t),
                  h === to.year
                    ...
                    : m && (h === to.day || h === to.week)
                    ? (t = o.makeTime(l, d, c + x * n * (h === to.day ? 1 : 7)))
                    : m && h === to.hour && n > 1
            ...
            return (r.info = _(t, { higherRanks: a, totalRange: h * n })), r
          }
      ...
      ;(tu.chart.styledMode = !0), (tu.chart.styledMode = !1)
      let tg = new tl(tu.time),
        tf = {
          defaultOptions: tu,
          defaultTime: tg,
          getOptions: function () {
          ...
          setOptions: function (t) {
            return (
              tc(k, 'setOptions', { options: t }),
              tp(!0, tu, t),
              t.time && tg.update(tu.time),
              t.lang &&
                'locale' in t.lang &&
                tg.update({ locale: t.lang.locale }),
              tu
            )
          }
        },
        { isNumber: tm, merge: tx, pInt: ty, defined: tb } = $
      class tv {
        static parse (t) {
        ...
        tweenTo (t, e) {
          let i = this.rgba,
            s = t.rgba
          if (!tm(i[0]) || !tm(s[0])) return t.input || 'none'
          let o = 1 !== s[3] || 1 !== i[3]
          return (
            (o ? 'rgba(' : 'rgb(') +
        ...
        (tv.parsers = [
          {
            ...
            parse: function (t) {
              return [ty(t[1]), ty(t[2]), ty(t[3]), parseFloat(t[4], 10)]
            }
          },
          {
            regex: /rgb\(\s*(\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d{1,3})\s*\)/,
            parse: function (t) {
              return [ty(t[1]), ty(t[2]), ty(t[3]), 1]
            }
          },
          {
      ...
      class tT {
        ...
        run (t, e, i) {
          let s = this,
            ...
            n = function () {
              for (let t = 0; t < tT.timers.length; t++)
                tT.timers[t]() || tT.timers.splice(t--, 1)
              tT.timers.length && a(n)
            }
        ...
        initPath (t, e, i) {
          ...
          return (
            u.length &&
              tM(l) &&
              ((d = r.length + l * n), p ? (g(u, r), f(r)) : (g(r, u), f(u))),
            [u, r]
          )
        }
        fillSetter () {
      ...
      function tB (t) {
        return tO(t)
          ? tE({ duration: 500, defer: 0 }, t)
          : { duration: t ? 500 : 0, defer: 0 }
      }
      function tN (t, e) {
        let i = tT.timers.length
        for (; i--; )
          tT.timers[i].elem !== t ||
            (e && e !== tT.timers[i].prop) ||
            (tT.timers[i].stopped = !0)
      }
      let tz = {
          ...
          setAnimation: function (t, e) {
            e.renderer.globalAnimation = tD(t, e.options.chart.animation, !0)
          },
          stop: tN
        },
        { SVG_NS: tR, win: tW } = k,
        ...
        tq =
          tV &&
          tY(tV.createPolicy) &&
          tV.createPolicy('highcharts', { createHTML: t => t }),
        tZ = tq ? tq.createHTML('') : ''
      class t_ {
        static filterUserAttributes (t) {
          return (
            tU(t, (e, i) => {
              let s = !0
              ;-1 === t_.allowedAttributes.indexOf(i) && (s = !1),
                -1 !==
                  ...
                  (s =
                    tj(e) &&
                    t_.allowedReferences.some(t => 0 === e.indexOf(t))),
                s ||
                  (tG(33, !1, void 0, {
                    'Invalid attribute in config': `${i}`
                  }),
                  delete t[i]),
                tj(e) && t[i] && (t[i] = e.replace(/</g, '&lt;'))
            }),
            t
          )
        }
        ...
        static setElementHTML (t, e) {
          ;(t.innerHTML = t_.emptyHTML), e && new t_(e).addToDOM(t)
        }
        constructor (t) {
              ...
              t$(e).forEach(function (e) {
                ...
                let r = e.tagName,
                  a = e.textContent
                    ...
                    : void 0,
                  n = t_.bypassHTMLFiltering
                if (r) {
                  if ('#text' === r) o = a
                  else if (-1 !== t_.allowedTags.indexOf(r) || n) {
                    let s = 'svg' === r ? tR : i.namespaceURI || tR,
                    ...
                    tU(e, function (t, e) {
                      ...
                      tH(h, n ? l : t_.filterUserAttributes(l)),
                      e.style && tF(h, e.style),
                      a && h.appendChild(a),
                      t(e.children || [], h),
                      (o = h)
                  } else tG(33, !1, void 0, { 'Invalid tagName in config': r })
                }
      ...
      ;(t_.allowedAttributes = [
        ...
        (t_.emptyHTML = tZ),
        (t_.bypassHTMLFiltering = !1)
      let { defaultOptions: tK, defaultTime: tJ } = tf,
        { doc: tQ } = k,
        {
          extend: t0,
          getNestedProperty: t1,
          isArray: t2,
          isNumber: t3,
          isObject: t5,
          pick: t6,
      ...
      function t7 (t = '', e, i) {
        let s = /\{([\p{L}\d:\.,;\-\/<>\[\]%_@"'’= #\(\)]+)\}/gu,
          ...
          a = /f$/,
          n = /\.(\d)/,
          h = i?.options.lang || tK.lang,
          l = (i && i.time) || tJ,
          d = (i && i.numberFormatter) || et,
          c = (t = '') => {
            let i
            return (
              'true' === t ||
        ...
        for (; null !== (p = s.exec(t)); ) {
          ...
          t4[a] && (u.isBlock && a === u.fn && g++, u.fn || (u.fn = a))
          let n = 'else' === p[1]
        ...
        return (
          r.forEach(s => {
            let o, r
            let { body: p, elseBody: u, expression: g, fn: m } = s
            if (m) {
              let t = [s],
                a = [],
                n = g.length,
              ...
              for (r = 0; r <= n; r++) {
                ...
                l || ('"' !== t && "'" !== t) ? l === t && (l = '') : (l = t),
                  l ||
                    (' ' !== t && r !== n) ||
                    (a.push(g.substr(h, r - h)), (h = r + 1))
              }
              for (r = t4[m].length; r--; ) t.unshift(c(a[r + 1]))
              ;(o = t4[m].apply(e, t)),
                s.isBlock && 'boolean' == typeof o && (o = t7(o ? p : u, e, i))
            } else {
              let t = g.split(':')
              if (
                ((o = c(t.shift() || '')), t.length && 'number' == typeof o)
              ) {
                let e = t.join(':')
                if (a.test(e)) {
      ...
      function et (t, e, i, s) {
        ...
        let p = s || i,
          u = p
            ? 'en'
            : this?.locale || h.locale || tQ.body.closest('[lang]')?.lang,
          g = JSON.stringify(c) + u
        return (
          (o = (t8[g] ?? (t8[g] = new Intl.NumberFormat(u, c))).format(t)),
          p && (o = o.replace(/\,/g, s ?? ',').replace('.', i ?? '.')),
          ((e || 0 != +o) && (!(n < 0) || d)) || (o = '0'),
          n && 0 != +o && (o += 'e' + (n < 0 ? '' : '+') + n),
          o
        )
      ...
      let ei = s,
        { clamp: es, pick: eo, pushUnique: er, stableSort: ea } = $
          ...
          for (c = e.length; c--; )
            (f = e[c]),
              (m =
                ...
                2),
              (f.pos = es(m - f.size * f.align, 0, i - f.size))
      ...
      let en = o,
        { animate: eh, animObject: el, stop: ed } = tz,
        {
          deg2rad: ec,
          doc: ep,
          svg: eu,
      ...
      class eX {
        ...
        align (t, e, i, s = !0) {
          ...
          t
            ...
            : ((t = this.alignOptions || {}),
              ...
              (i = this.alignTo))
          let h = !i || eE(i) ? i || 'renderer' : void 0
          h && (n && ez(a, this), (i = void 0))
          let l = eB(i, r[h], r),
            d =
              (l.x || 0) +
              (t.x || 0) +
              ((l.width || 0) - (t.width || 0)) * eC(t.align),
            c =
              (l.y || 0) +
              (t.y || 0) +
              ((l.height || 0) - (t.height || 0)) * eC(t.verticalAlign)
          return (
            (o[e ? 'translateX' : 'x'] = Math.round(d)),
            (o[e ? 'translateY' : 'y'] = Math.round(c)),
            s &&
              (this[this.placed ? 'animate' : 'attr'](o), (this.placed = !0)),
            (this.alignAttr = o),
            this
          )
        }
        ...
        animate (t, e, i) {
          let s = el(eB(e, this.renderer.globalAnimation, !0)),
            o = s.defer
          return (
            ep.hidden && (s.duration = 0),
            0 !== s.duration
              ? (i && (s.complete = i),
                eW(() => {
        ...
        applyTextOutline (t) {
          ...
          if (o && 'none' !== o && k.svg) {
            ...
            let t = ep.createElementNS(eg, 'tspan')
            ey(t, {
            ...
            let a = ep.createElementNS(eg, 'tspan')
            ;(a.textContent = '​'),
              ey(a, { x: Number(e.getAttribute('x')), dy: -r }),
              t.appendChild(a),
        ...
        clip (t) {
          if (t && !t.clipPath) {
            ...
            eS(t, { clipPath: i, id: e, count: 0 }), t.add(i)
          }
          return this.attr(
            'clip-path',
        ...
        crisp (t, e) {
          ...
          let i = t.x || this.x || 0,
            ...
            n = ev(s, e)
          return (
            eS(t, { x: a, y: n, width: ev(o, e) - a, height: ev(r, e) - n }),
            ew(t.strokeWidth) && (t.strokeWidth = e),
            t
          )
        }
        complexColor (t, e, i) {
          let s = this.renderer,
            ...
            g = [],
            f
          eT(this.renderer, 'complexColor', { args: arguments }, function () {
            if (
              (t.radialGradient
                ? (r = 'radialGradient')
            ...
            e && (t = eS(e, i)),
              null === t.width || 'auto' === t.width
                ...
                : 'text' === s.nodeName.toLowerCase() &&
                  t.width &&
                  (o = this.textWidth = eN(t.width)),
              eS(this.styles, t),
              o && !eu && this.renderer.forExport && delete t.width
            let r = (em && t.fontSize) || null
            r && (eL(r) || /^\d+$/.test(r)) && (t.fontSize += 'px')
            let a = eI(t)
        ...
        dashstyleSetter (t) {
          ...
          if (('inherit' === i && (i = 1), (t = t && t.toLowerCase()))) {
            let s = t
              ...
              .replace(/,$/, '')
              .split(',')
            for (e = s.length; e--; ) s[e] = '' + eN(s[e]) * eB(i, NaN)
        ...
        destroy () {
          ...
          t.alignOptions && eM(i.alignedObjects, t),
            eD(t, function (e, i) {
        ...
        getBBox (t, e) {
          ...
          let {
            ...
            g = eB(e, this.rotation, 0),
            f = h.styledMode
              ? n && eX.prototype.getStyle.call(n, 'font-size')
              : l.fontSize
          if (
            (ew(d) &&
            ...
            let t = { bBox: i }
            eT(this, 'afterGetBBox', t), (i = t.bBox)
          }
          if (r && ('' === d || i.height > 0)) {
        ...
        constructor (t, e) {
          ;(this.onEvents = {}),
            ...
            (this.element =
              'span' === e || 'body' === e
                ? eb(e)
                : ep.createElementNS(this.SVG_NS, e)),
            (this.renderer = t),
            (this.styles = {}),
            eT(this, 'afterInit')
        }
        on (t, e) {
          let { onEvents: i } = this
          return i[t] && i[t](), (i[t] = ex(this.element, t, e)), this
        }
        opacitySetter (t, e, i) {
        ...
        strokeWidth () {
          ...
          return (
            /px$/.test(t)
              ? (e = eN(t))
              : '' !== t &&
                (ey((i = ep.createElementNS(eg, 'rect')), {
                  width: t,
                  'stroke-width': 0
                }),
        ...
        symbolAttr (t) {
          let e = this
          eX.symbolCustomAttribs.forEach(function (i) {
            e[i] = eB(t[i], e[i])
          }),
            e.attr({
        ...
        updateTransform (t = 'transform') {
          let {
            ...
            d = ['translate(' + h + ',' + l + ')']
          ew(i) && d.push('matrix(' + i.join(',') + ')'),
            s &&
              (d.push(
                'rotate(' +
                  s +
                  ' ' +
                  eB(o, e.getAttribute('x'), 0) +
                  ' ' +
                  eB(r, e.getAttribute('y') || 0) +
                  ')'
              ),
          ...
          if (
            (ew(t)
              ? (r.setAttribute('data-z-index', t),
                (t = +t),
                this[e] === t && (p = !1))
              : ew(this[e]) && r.removeAttribute('data-z-index'),
            (this[e] = t),
            p)
          ) {
            for (
              ...
              (c = !ew((l = (h = n[u]).getAttribute('data-z-index')))),
                h !== r &&
                  (t < 0 && c && !a && !u
      ...
      ;(eX.symbolCustomAttribs = [
        ...
        (eX.prototype.strokeSetter = eX.prototype.fillSetter),
        (eX.prototype.yGetter = eX.prototype.xGetter),
        (eX.prototype.matrixSetter =
          eX.prototype.rotationOriginXSetter =
          eX.prototype.rotationOriginYSetter =
          eX.prototype.rotationSetter =
          eX.prototype.scaleXSetter =
          eX.prototype.scaleYSetter =
          eX.prototype.translateXSetter =
          eX.prototype.translateYSetter =
          eX.prototype.verticalAlignSetter =
            function (t, e) {
      ...
      class eZ extends eF {
        ...
        alignSetter (t) {
          ...
          e !== this.alignFactor &&
            ((this.alignFactor = e),
            this.bBox && eU(this.xSetting) && this.attr({ x: this.xSetting }))
        }
        anchorXSetter (t, e) {
          ;(this.anchorX = t),
            this.boxAttr(
        ...
        css (t) {
          ...
          return eF.prototype.css.call(this, t)
        }
        destroy () {
          eq(this.element, 'mouseenter'),
            eq(this.element, 'mouseleave'),
        ...
        updateBoxSize () {
          ...
          let e = this.text,
            ...
            s = this.padding,
            o = (this.bBox =
              (!eU(this.widthSetting) ||
                !eU(this.heightSetting) ||
                this.textAlign) &&
              eG(e.textStr)
                ? e.getBBox(void 0, 0)
                : eZ.emptyBBox)
          ...
          if (
            ...
            ;(t = this.getCrispAdjust()),
              ...
              this.box.attr(eY(i, this.deferredAttr)),
              (this.deferredAttr = {})
          }
        }
        updateTextPadding () {
          ...
          if (!t.textPath) {
            ...
            let e = this.baseline ? 0 : this.baselineOffset,
              i =
                ...
                (eG(this.widthSetting) && this.bBox
                  ? ej(this.textAlign) * (this.widthSetting - this.bBox.width)
                  : 0)
            ;(i !== t.x || e !== t.y) &&
              (t.attr('x', i),
        ...
        widthSetter (t) {
          ;(this.widthSetting = eU(t) ? t : void 0), (this.doUpdate = !0)
        }
        getPaddedWidth () {
          let t = this.padding,
            e = eV(this.paddingLeft, t),
            i = eV(this.paddingRight, t)
      ...
      ;(eZ.emptyBBox = { width: 0, height: 0, x: 0, y: 0 }),
        (eZ.textProps = [
          'color',
          'direction',
          'fontFamily',
      ...
      let { defined: e_, isNumber: eK, pick: eJ } = $
      function eQ (t, e, i, s, o) {
        let r = []
        if (o) {
          let a = o.start || 0,
            n = eJ(o.r, i),
            ...
            m = Math.cos(c),
            x = Math.sin(c),
            y = eJ(o.longArc, c - a - Math.PI < l ? 0 : 1),
            b = ['A', n, h, 0, y, eJ(o.clockwise, 1), t + n * m, e + h * x]
          ;(b.params = { start: a, end: c, cx: t, cy: e }),
            r.push(['M', t + n * g, e + h * f], b),
            e_(p) &&
              (((b = [
                'A',
                p,
                ...
                0,
                y,
                e_(o.clockwise) ? 1 - o.clockwise : 0,
                t + p * g,
                e + p * f
              ]).params = { start: c, end: a, cx: t, cy: e }),
              r.push(
                u ? ['M', t + p * m, e + p * x] : ['L', t + p * m, e + p * x],
                b
              )),
            u || r.push(['Z'])
        }
      ...
      let e2 = {
          ...
          callout: function (t, e, i, s, o) {
            let r = Math.min((o && o.r) || 0, i, s),
              ...
              h = (o && o.anchorY) || 0,
              l = e1(t, e, i, s, { r })
            if (!eK(n) || (n < i && n > 0 && h < s && h > 0)) return l
            if (t + n > i - a) {
              if (h > e + a && h < e + s - a)
                l.splice(
                  3,
        ...
        is = class {
          ...
          buildSVG () {
            ...
            if (n !== t.textCache) {
              ...
              } else e.appendChild(e3.createTextNode(this.unescapeEntities(s)))
              e7(this.textOutline) &&
                t.applyTextOutline &&
            ...
            ;[].forEach.call(
              ...
              (t, s) => {
                t.nextSibling &&
                  ...
                  e9(t, { dy: this.getLineHeight(t.nextSibling), x: i }))
              }
            )
            let s = this.width || 0
            if (!s) return
            let o = (t, o) => {
                ...
                if (n) {
                  ...
                  n.forEach(e => {
                    ...
                    r.forEach(e => {
                      o.insertBefore(e3.createTextNode(e), t)
                      let s = e3.createElementNS(e5, 'tspan')
                      ;(s.textContent = '​'),
                        e9(s, { dy: h, x: i }),
                        o.insertBefore(s, t)
                    })
                } else
                  this.ellipsis && r && this.truncate(t, r, void 0, 0, s, l, ii)
              },
              r = t => {
                ;[].slice.call(t.childNodes).forEach(i => {
                  i.nodeType === e6.Node.TEXT_NODE
                    ? o(i, t)
          ...
          getLineHeight (t) {
            let e = t.nodeType === e6.Node.TEXT_NODE ? t.parentElement : t
          ...
          modifyTree (t) {
            let e = (i, s) => {
              ...
              '#text' !== n && 'a' !== n && (i.tagName = 'tspan'),
                e4(i, { attributes: o, style: a }),
                r && r.filter(t => '#text' !== t.tagName).forEach(e)
            }
            t.forEach(e), e8(this.svgElement, 'afterModifyTree', { nodes: t })
          }
          truncate (t, e, i, s, o, r, a) {
            ...
            if (((l.rotation = 0), s + (h = f(t.textContent.length)) > o)) {
              ...
              0 === u
                ? (t.textContent = '')
                : (e && u === e.length - 1) ||
                  (t.textContent = n || a(e || i, g)),
                this.ellipsis &&
                  h > o &&
                  this.truncate(t, t.textContent || '', void 0, 0, o, r, ii)
            }
            i && i.splice(0, g), (l.actualWidth = h), (l.rotation = d)
          }
          unescapeEntities (t, e) {
            return (
              it(this.renderer.escapes, function (i, s) {
                ;(e && -1 !== e.indexOf(i)) ||
      ...
      class iB {
        constructor (t, e, i, s, o, r, a) {
          ...
          a || l.css(this.getStyle(s || {})),
            t.appendChild(d),
            iy(t, 'dir', 'ltr'),
            -1 === t.innerHTML.indexOf('xmlns') && iy(d, 'xmlns', this.SVG_NS),
            (this.box = d),
            (this.boxWrapper = l),
            (this.alignedObjects = []),
            ...
            this.createElement('desc')
              .add()
              .element.appendChild(
                ih.createTextNode('Created with Highcharts 12.0.2')
              ),
            ...
            il &&
              ...
              (this.unSubPixelFix = ix(im, 'resize', n)))
        }
        definition (t) {
          return new t_([t]).addToDOM(this.defs.element)
        }
        getReferenceURL () {
          if ((il || ic) && ih.getElementsByTagName('base').length) {
            if (!iw(e)) {
              let t = iD(),
                i = new t_([
                  {
              ...
              let s = ih.elementFromPoint(6, 6)
              ;(e = 'hitme' === (s && s.id)), ih.body.removeChild(i)
            }
            if (e)
              return iI(
                im.location.href.split('#')[0],
                [/<[^>]*>/g, ''],
                [/([\('\)])/g, '\\$1'],
                [/ /g, '%20']
              )
        ...
        button (t, e, i, s, o = {}, r, a, n, h, l) {
          let d = this.label(t, e, i, h, void 0, void 0, l, void 0, 'button'),
            ...
            p = arguments,
            u = 0
          ;(o = iL(io.global.buttonTheme, o)),
            c && (delete o.fill, delete o.stroke, delete o['stroke-width'])
          let g = o.states || {},
            f = o.style || {}
          delete o.states, delete o.style
          let m = [t_.filterUserAttributes(o)],
            x = [f]
          return (
            c ||
              ['hover', 'select', 'disabled'].forEach((t, e) => {
                m.push(
                  iL(m[0], t_.filterUserAttributes(p[e + 5] || g[t] || {}))
                ),
                  x.push(m[e + 1].style),
                  delete m[e + 1].style
              }),
            ix(d.element, id ? 'mouseover' : 'mouseenter', function () {
              3 !== u && d.setState(1)
            }),
            ix(d.element, id ? 'mouseout' : 'mouseleave', function () {
              3 !== u && d.setState(u)
            }),
            (d.setState = (t = 0) => {
              if (
        ...
        crispLine (t, e) {
          let [i, s] = t
          return (
            iw(i[1]) && i[1] === s[1] && (i[1] = s[1] = iv(i[1], e)),
            iw(i[2]) && i[2] === s[2] && (i[2] = s[2] = iv(i[2], e)),
            t
          )
        }
        path (t) {
          ...
          return (
            iT(t) ? (e.d = t) : iA(t) && iS(e, t),
            this.createElement('path').attr(e)
          )
        }
        circle (t, e, i) {
          let s = iA(t) ? t : void 0 === t ? {} : { x: t, y: e, r: i },
        ...
        rect (t, e, i, s, o, r) {
          ...
          return (
            this.styledMode ||
              (void 0 !== r && ((a['stroke-width'] = r), iS(a, n.crisp(a))),
              (a.fill = 'none')),
            (n.rSetter = function (t, e, i) {
              ;(n.r = t), iy(i, { rx: t, ry: t })
            }),
            (n.rGetter = function () {
              return n.r || 0
            }),
        ...
        image (t, e, i, s, o, r) {
          ...
          if (r) {
            ...
            let e = new im.Image()
            ix(e, 'load', h), (e.src = t), e.complete && h({})
          } else n.attr({ href: t })
          return n
        }
        symbol (t, e, i, s, o, r) {
          ...
          if (g)
            'number' == typeof e &&
              (n = g.call(this.symbols, e || 0, i || 0, s || 0, o || 0, r)),
              (a = this.path(n)),
            ...
            ;(s.imgwidth = iO(r && r.width, ig[h] && ig[h].width)),
              (s.imgheight = iO(r && r.height, ig[h] && ig[h].height)),
              ...
              (s.isImg = !0),
              (s.symbolUrl = t),
              iw(s.imgwidth) && iw(s.imgheight)
                ? l(s)
                : (s.attr({ width: 0, height: 0 }),
                  ib('img', {
                    onload: function () {
                      let t = ir[d.chartIndex]
                      0 === this.width &&
                        (ik(this, { position: 'absolute', top: '-999em' }),
                        ih.body.appendChild(this)),
                        (ig[h] = { width: this.width, height: this.height }),
        ...
        fontMetrics (t) {
          let e = iE(eF.prototype.getStyle.call(t, 'font-size') || 0),
        ...
        rotCorr (t, e, i) {
          let s = t
          return (
            e && i && (s = Math.max(s * Math.cos(e * ia), 4)),
            { x: (-t / 3) * Math.sin(e * ia), y: s }
          )
        }
        pathToSegments (t) {
          let e = [],
        ...
        label (t, e, i, s, o, r, a, n, h) {
          return new eZ(this, t, e, i, s, o, r, a, n, h)
        }
        alignElements () {
      ...
      iS(iB.prototype, {
        ...
        ei.registerRendererType('svg', iB, !0)
      let { composed: iN } = k,
        {
          attr: iz,
          css: iR,
      ...
      function iU (t, e, i) {
        ...
        eF.prototype[`${e}Setter`].call(this, t, e, i), s && (s[e] = t)
      }
      let i$ = (t, e) => {
        if (!t.div) {
          ...
          ;(t.classSetter = (t, e, i) => {
            ...
            (t.opacitySetter = t.visibilitySetter = iU),
            (t.css = e => (
              s.call(t, e),
      ...
      class iV extends eF {
        ...
        css (t) {
          ...
          let { element: i } = this,
            ...
            o = s && t.width
          return (
            s && (delete t.width, (this.textWidth = iY(o) || void 0), (e = !0)),
            ...
            t?.lineClamp &&
              ...
              (t.overflow = 'hidden')),
            iG(Number(t?.fontSize)) && (t.fontSize = t.fontSize + 'px'),
            iX(this.styles, t),
            iR(i, t),
        ...
        updateTransform () {
          ...
          let {
            ...
            { display: g = 'block', whiteSpace: f } = n
          if (
            (iR(t, { marginLeft: `${d}px`, marginTop: `${c}px` }),
            'SPAN' === t.tagName)
          ) {
            ...
            if (l !== this.oldTextWidth) {
              let e = this.textPxLength
                  ? this.textPxLength
                  : (iR(t, { width: '', whiteSpace: f || 'nowrap' }),
                    t.offsetWidth),
                s = l || 0
            ...
            ;(this.hasBoxWidthChanged = m),
              n !== this.cTT &&
                ...
                this.getSpanCorrection(
                  (!iH(i) && !this.textWidth && this.textPxLength) ||
                    t.offsetWidth,
                  c,
                  iF(h)
                ))
            let { xCorr: x = 0, yCorr: y = 0 } = this,
              b = {
                ...
                top: `${u + y}px`,
                textAlign: h,
                transformOrigin: `${(s ?? p) - x - p - d}px ${
                  (o ?? u) - y - u - d
                }px`
              }
            ;(r || a) && (b.transform = `scale(${r ?? 1},${a ?? 1})`),
              iR(t, b),
              (this.cTT = n),
              (this.oldRotation = i),
              (this.oldAlign = h)
        ...
        add (t) {
          ...
          if (((this.parentGroup = t), t && !(e = t.div))) {
            ...
            for (let t of s.reverse()) e = i$(t, i)
          }
          return (
        ...
        textSetter (t) {
          t !== this.textStr &&
            ...
            t_.setElementHTML(this.element, t ?? ''),
            (this.textStr = t),
            (this.doTransform = !0))
        }
        alignSetter (t) {
      ...
      let iq = iV.prototype
      ;(iq.visibilitySetter = iq.opacitySetter = iU),
        (iq.ySetter =
          iq.rotationSetter =
          iq.rotationOriginXSetter =
          iq.rotationOriginYSetter =
            iq.xSetter),
        (function (t) {
          ;(t.xAxis = {
            alignTicks: !0,
      ...
      let iZ = r,
        { addEvent: i_, isFunction: iK, objectEach: iJ, removeEvent: iQ } = $
      ;(a || (a = {})).registerEventOptions = function (t, e) {
        ;(t.eventOptions = t.eventOptions || {}),
          iJ(e.events, function (e, i) {
            t.eventOptions[i] !== e &&
              (t.eventOptions[i] &&
                (iQ(t, i, t.eventOptions[i]), delete t.eventOptions[i]),
              iK(e) && ((t.eventOptions[i] = e), i_(t, i, e, { order: 0 })))
          })
      }
      let i0 = a,
        { deg2rad: i1 } = k,
        ...
        ss = class {
          ...
          addLabel () {
            let t = this,
              ...
              a = e.names,
              n = t.pos,
              h = si(t.options && t.options.labels, i.labels),
              l = e.tickPositions,
              d = n === l[0],
              c = n === l[l.length - 1],
              ...
              m,
              x,
              y = this.parameters.category || (o ? si(o[n], a[n], n) : n)
            r && i7(y) && (y = i3(r.lin2log(y))),
              e.dateTime &&
                (u
                  ? (f = (m = s.time.resolveDTLFormat(
                      i.dateTimeLabelFormats[
                        (!i.grid && u.higherRanks[n]) || u.unitName
                      ]
                    )).main)
                  : i7(y) &&
            ...
            w
              ? (t.shortenLabel = function () {
                  for (x = 0; x < w.length; x++)
                    if (
                      (i9(b, { dateTimeLabelFormat: w[x] }),
                      g.attr({ text: v.call(b, b) }),
                      g.getBBox().width <
              ...
              i5(g) || t.movedLabel
                ...
                : ((t.label = g = t.createLabel(k, h)), (t.rotation = 0))
          }
          createLabel (t, e, i) {
            let s = this.axis,
            ...
            if (a) {
              ...
              r || a.css(st(e.style, { whiteSpace: 'nowrap' })),
          ...
          getPosition (t, e, i, s) {
            let o = this.axis,
              ...
              n = {
                x: t
                  ? i3(o.translate(e + i, void 0, void 0, s) + o.transB)
                  : o.left +
                    o.offset +
                    (o.opposite
                ...
                y: t
                  ...
                  : i3(a - o.translate(e + i, void 0, void 0, s) - o.transB)
              }
            return (
              (n.y = i2(n.y, -1e9, 1e9)),
              i4(this, 'afterGetPosition', { pos: n }),
              n
            )
          }
            ...
            return (
              (h =
                0 === d.side
                  ...
                  : 2 === d.side
                  ? g.y + m
                  : Math.cos(i.rotation * i1) *
                    (g.y - i.getBBox(!1, 0).height / 2)),
              i5(o.y) && (h = 0 === d.side && d.horiz ? o.y + h : o.y),
              (t =
                t +
          ...
          handleOverflow (t) {
            let e = this.axis,
              ...
              r = e.chart.spacing,
              a = si(e.labelLeft, Math.min(e.pos, r[3])),
              n = si(
                e.labelRight,
              ...
              h = this.label,
              l = this.rotation,
              d = i8(e.labelAlign || h.attr('align')),
              c = h.getBBox().width,
            ...
            l || 'justify' !== i.overflow
              ? l < 0 && s - d * c < a
                ? (x = Math.round(s / Math.cos(l * i1) - a))
                : l > 0 &&
                  s + d * c > n &&
                  (x = Math.round((o - s) / Math.cos(l * i1)))
              : ((f = s - d * c),
                (m = s + (1 - d) * c),
                f < a
                  ? (u = t.x + u * (1 - d) - a)
                ...
                (c > u || (e.autoRotation && (h.styles || {}).width)) &&
                  (x = u)),
              x &&
                h &&
                (this.shortenLabel
          ...
          render (t, e, i) {
            let s = this.axis,
              o = s.horiz,
              r = this.pos,
              a = si(this.tickmarkOffset, s.tickmarkOffset),
              ...
              c = d + s.len,
              p = o ? h : l
            !s.chart.polar && this.isNew && (i3(p) < d || p > c) && (i = 0)
            let u = si(i, this.label && this.label.newOpacity, 1)
            ;(i = si(i, 1)),
              (this.isActive = !0),
          ...
          renderGridLine (t, e) {
            let i = this.axis,
              ...
              r = this.pos,
              a = this.type,
              n = si(this.tickmarkOffset, i.tickmarkOffset),
              h = i.chart.renderer,
              l = this.gridLine,
              d,
              c = s.gridLineWidth,
        ...
        { animObject: so } = tz,
        { xAxis: sr, yAxis: sa } = iZ,
        { defaultOptions: sn } = tf,
        { registerEventOptions: sh } = i0,
        { deg2rad: sl } = k,
        {
          arrayMax: sd,
          arrayMin: sc,
          ...
          correctFloat: su,
          defined: sg,
          destroyObjectProperties: sf,
          erase: sm,
          error: sx,
          extend: sy,
          fireEvent: sb,
          getClosestDistance: sv,
          insertItem: sk,
          isArray: sw,
          isNumber: sM,
          isString: sS,
          merge: sT,
          normalizeTickInterval: sC,
          objectEach: sA,
          pick: sP,
          relativeLength: sL,
          removeEvent: sO,
        ...
        sD = (t, e) =>
          sC(
            ...
            void 0,
            void 0,
            sP(t.options.allowDecimals, e < 0.5 || void 0 !== t.tickAmount),
            !!t.tickAmount
          )
      sy(sn, { xAxis: sr, yAxis: sT(sr, sa) })
      class sB {
        constructor (t, e, i) {
          this.init(t, e, i)
        }
        init (t, e, i = this.coll) {
          ...
          ;(this.chart = t),
            ...
            (this.isXAxis = s),
            (this.coll = i),
            sb(this, 'init', { userOptions: e }),
            (this.opposite = sP(e.opposite, this.opposite)),
            (this.side = sP(
              e.side,
              this.side,
          ...
          this.type ?? (this.type = r.type || 'linear'),
            ...
            (this.max = void 0),
            (this.min = void 0)
          let n = sP(r.crosshair, sE(t.options.tooltip.crosshairs)[s ? 0 : 1])
          ;(this.crosshair = !0 === n ? {} : n),
            ...
            t.inverted &&
              ...
              !sg(this.reversed) &&
              (this.reversed = !0),
            (this.labelRotation = sM(a.rotation) ? a.rotation : void 0),
            sh(this, r),
            sb(this, 'afterInit')
        }
        setOptions (t) {
          ...
          ;(this.options = sT(e, sn[this.coll], t)),
            sb(this, 'afterSetOptions', { userOptions: t })
        }
        defaultLabelFormatter () {
          let t = this.axis,
            { numberFormatter: e } = this.chart,
            i = sM(this.value) ? this.value : NaN,
            s = t.chart.time,
            o = t.categories,
        ...
        getSeriesExtremes () {
          let t
          let e = this
          sb(this, 'getSeriesExtremes', null, function () {
                  ...
                  if (
                    ...
                    (o = i.getColumn('x')).length &&
                      ...
                      sM(a) ||
                        ...
                        (n = t.max)),
                      o.length &&
                        ((e.dataMin = Math.min(sP(e.dataMin, a), a)),
                        (e.dataMax = Math.max(sP(e.dataMax, n), n))))
                  else {
            ...
            sb(this, 'afterGetSeriesExtremes')
        }
        ...
        getPlotLinePath (t) {
          ...
          return (
            sb(this, 'getPlotLinePath', b, function (t) {
              ;(u = f =
                (c = sp(
                  (c = sP(c, e.translate(a, void 0, void 0, r))),
                  -1e9,
                  1e9
                )) + d),
                (g = m = h - c - d),
        ...
        getLinearTickPositions (t, e, i) {
          let s, o, r
          let a = su(Math.floor(e / t) * t),
            n = su(Math.ceil(i / t) * t),
            h = []
          if ((su(a + t) === a && (r = 20), this.single)) return [e]
          for (s = a; s <= n && (h.push(s), (s = su(s + t, r)) !== o); ) o = s
          return h
        }
        getMinorTickInterval () {
          let { minorTicks: t, minorTickInterval: e } = this.options
          return !0 === t ? sP(e, 'auto') : !1 !== t ? e : void 0
        }
        ...
        adjustForMinRange () {
          ...
          this.isXAxis &&
            ...
            !e &&
            (r =
              sg(t.min) || sg(t.max) || sg(t.floor) || sg(t.ceiling)
                ? null
                : Math.min(
                    5 *
                      (sv(
            ...
            this.series.forEach(function (t) {
              ...
              1 === o.length
                ...
                : t.sorted &&
                  sg(s) &&
                  t.reserveSpace() &&
                  (e = sg(e) ? Math.min(e, s) : s)
            }),
              i.length && (i.sort((t, e) => t - e), (t = sv([i])))
          }
          return t && e ? Math.min(t, e) : t || e
        }
        nameToX (t) {
          let e = sw(this.options.categories),
        ...
        setAxisTranslation () {
          ...
          ;(o || s || r) &&
            ...
            sb(this, 'afterSetAxisTranslation')
        }
        minFromRange () {
          let { max: t, min: e } = this
          return (sM(t) && sM(e) && t - e) || void 0
        }
        setTickInterval (t) {
          let {
              categories: e,
            ...
            d = i.time,
            c = sM(this.threshold) ? this.threshold : void 0,
            p = this.minRange || 0,
            { ceiling: u, floor: g, linkedTo: f, softMax: m, softMin: x } = h,
            y = sM(f) && i[this.coll]?.[f],
            ...
            M,
            S =
              sM(h.tickInterval) && h.tickInterval >= 0
                ? h.tickInterval
                : void 0,
            T,
            C,
          ...
          if (
            ...
            (A = sP(this.userMin, d.parse(h.min))),
            (P = sP(this.userMax, d.parse(h.max))),
            y
              ? ((this.linkedParent = y),
                (M = y.getExtremes()),
                (this.min = sP(M.min, M.dataMin)),
                (this.max = sP(M.max, M.dataMax)),
                this.type !== y.type && sx(11, !0, i))
              : (l &&
                  sg(c) &&
                  sM(s) &&
                  sM(o) &&
            ...
            sM(this.max) &&
              ...
              (n &&
                (this.positiveValuesOnly &&
                  !t &&
                  0 >= Math.min(this.min, sP(o, this.min)) &&
                  sx(10, !0, i),
                (this.min = su(n.log2lin(this.min), 16)),
                (this.max = su(n.log2lin(this.max), 16))),
              this.range &&
                sM(o) &&
                ((this.userMin =
                  this.min =
                ...
                (this.range = void 0))),
            sb(this, 'foundExtremes'),
            this.adjustForMinRange(),
            sM(this.min) && sM(this.max))
          ) {
            if (
              (!sM(this.userMin) && sM(x) && x < this.min && (this.min = A = x),
              !sM(this.userMax) && sM(m) && m > this.max && (this.max = P = m),
              e ||
                this.axisPointRange ||
                ...
                (!sg(A) && k && (this.min -= w * k),
                sg(P) || !v || (this.max += w * v)),
              !sM(this.userMin) && sM(g) && (this.min = Math.max(this.min, g)),
              !sM(this.userMax) && sM(u) && (this.max = Math.min(this.max, u)),
              l && sM(o) && sM(s))
            ) {
              let t = c || 0
              !sg(A) && this.min < t && o >= t
            ...
            !i.polar &&
              ...
              (sg(h.min)
                ? (this.max = this.min)
                : sg(h.max) && (this.min = this.max)),
              (w = this.max - this.min)
          }
          if (
            (this.min !== this.max && sM(this.min) && sM(this.max)
              ? y && !S && b === y.options.tickPixelInterval
                ? (this.tickInterval = S = y.tickInterval)
                : (this.tickInterval = sP(
                    S,
                    this.tickAmount
            ...
            this.series.forEach(function (e) {
              ...
              sb(this, 'postProcessData', { hasExtremesChanged: t })
          }
          this.setAxisTranslation(),
            sb(this, 'initialAxisTranslation'),
            this.pointRange &&
              !S &&
          ...
          !S && this.tickInterval < L && (this.tickInterval = L),
            r || n || S || (this.tickInterval = sD(this, this.tickInterval)),
        ...
        setTickPositions () {
          ...
          if (
            ...
            if (
              ...
              (n = [this.min, this.max]), sx(19, !1, this.chart)
              ...
              for (; e <= 2 * t; )
                if (
                  ...
                  this.tickInterval = sD(this, (e *= 1.1))
                else break
            }
            n.length > this.len &&
          ...
          ;(this.tickPositions = n),
            ...
            sb(this, 'afterSetTickPositions')
        }
        trimTicks (t, e, i) {
          let s = t[0],
            o = t[t.length - 1],
            r = (!this.isOrdinal && this.minPointOffset) || 0
          if ((sb(this, 'trimTicks'), !this.isLinked)) {
        ...
        alignToOthers () {
          ...
          if (t && a) {
            ...
            let t =
              n.length > 1 ? n.reduce((t, e) => (t += e), 0) / n.length : void 0
            s.forEach(e => {
        ...
        adjustTickAmount () {
          let t = this,
            ...
            h = r?.length,
            l = sP(t.threshold, t.softThreshold ? 0 : null),
            d,
            c,
            p = t.tickInterval,
            u,
            g = () => r.push(su(r[r.length - 1] + p)),
            f = () => r.unshift(su(r[0] - p))
          if (
            (sM(n) &&
              ((u = n < 0.5 ? Math.ceil(n * (a - 1)) : Math.floor(n * (a - 1))),
              o.reversed && (u = a - 1 - u)),
            t.hasData() && sM(s) && sM(i))
          ) {
            let n = () => {
            ...
            if (sM(u) && sM(t.threshold)) {
              for (
                ;
                r[u] !== l || r.length !== a || r[0] > s || r[r.length - 1] < i;
        ...
        setExtremes (t, e, i = !0, s, o) {
          ...
          this.series.forEach(t => {
            ...
            (t = r.time.parse(t)),
            (e = r.time.parse(e)),
            sb(this, 'setExtremes', (o = sy(o, { min: t, max: e })), t => {
              ;(this.userMin = t.min),
                (this.userMax = t.max),
                (this.eventArgs = t),
                i && r.redraw(s)
        ...
        setAxisSize () {
          let t = this.chart,
            ...
            o = (this.width = Math.round(
              sL(sP(e.width, t.plotWidth - i[3] + i[1]), t.plotWidth)
            )),
            r = (this.height = Math.round(
              sL(sP(e.height, t.plotHeight - i[0] + i[2]), t.plotHeight)
            )),
            a = (this.top = Math.round(
              sL(sP(e.top, t.plotTop + i[0]), t.plotHeight, t.plotTop)
            )),
            n = (this.left = Math.round(
              sL(sP(e.left, t.plotLeft + i[3]), t.plotWidth, t.plotLeft)
            ))
        ...
        getExtremes () {
          ...
          return {
            min: t ? su(t.lin2log(this.min)) : this.min,
            max: t ? su(t.lin2log(this.max)) : this.max,
        ...
        autoLabelAlign (t) {
          let e = (sP(t, 0) - 90 * this.side + 720) % 360,
            i = { align: 'center' }
          return (
            sb(this, 'autoLabelAlign', i, function (t) {
              e > 15 && e < 165
                ? (t.align = 'right')
        ...
        tickSize (t) {
          ...
          let r = { tickSize: o }
          return sb(this, 'afterTickSize', r), r.tickSize
        }
        labelMetrics () {
        ...
        unsquish () {
          ...
          return (
            (this.autoRotation = p),
            (this.labelRotation = sP(d, sM(r) ? r : 0)),
            t.step ? s : l
          )
        }
        getSlotWidth (t) {
          let e = this.chart,
            ...
            r = e.margin[3]
          if (t && sM(t.slotWidth)) return t.slotWidth
        ...
        renderUnsquish () {
          let t = this.chart,
            ...
            g = 0
          sS(o.rotation) || (l.rotation = o.rotation || 0),
            ...
            i.forEach(function (t) {
              ...
              i &&
                ...
                e.shortenLabel
                  ...
                  ? i.css(sy(a, { width: `${p}px`, lineClamp: u }))
        ...
        hasData () {
          return (
            ...
            (this.options.showEmpty && sg(this.min) && sg(this.max))
          )
        }
        addTitle (t) {
          let e
          ...
          this.axisTitle ||
            ...
            a || this.axisTitle.css(sT(r.style)),
        ...
        generateTick (t) {
          let e = this.ticks
          e[t] ? e[t].addLabel() : (e[t] = new ss(this, t))
        }
        createGroups () {
          ...
          if (
            ...
            d?.text &&
              ...
              m &&
                ...
                (b = sg((y = d.offset)) ? 0 : sP(d.margin, i ? 5 : 10)))),
            t.renderLine(),
            (t.offset = f * sP(s.offset, u[o] ? u[o] + (s.margin || 0) : 0)),
            ...
            v &&
              ...
              (k +=
                f *
                (i
                  ? sP(c.y, t.tickRotCorr.y + f * c.distance)
                  : sP(c.x, f * c.distance)))),
            (t.axisTitleMargin = sP(y, k)),
        ...
        getTitlePosition (t) {
          ...
          return sb(this, 'afterGetTitlePosition', { titlePosition: f }), f
        }
        renderMinorTick (t, e) {
          let i = this.minorTicks
          i[t] || (i[t] = new ss(this, t, 'minor')),
        ...
        render () {
          ...
          if (i.hasData() || n) {
            let r = i.chart.hasRendered && i.old && sM(i.old.min)
            i.minorTickInterval &&
              !i.categories &&
          ...
          ;[d, c, p].forEach(function (t) {
            ...
            l &&
              ...
              (l.isNew = !1)),
            u && u.enabled && i.stacking && i.stacking.renderStackTotals(),
            (i.old = {
              len: i.len,
              max: i.max,
              min: i.min,
        ...
        getKeepProps () {
          return this.keepProps || sB.keepProps
        }
        destroy (t) {
          let e = this,
        ...
        drawCrosshair (t, e) {
          let i = this.crosshair,
            ...
            l
          if (
            (sb(this, 'drawCrosshair', { e: t, point: e }),
            ...
            if (
              ...
              sg(a) &&
                ((l = {
                  value: e && (this.isXAxis ? e.x : sP(e.stackY, e.y)),
                  translatedValue: a
                }),
                o.polar &&
                  sy(l, {
                  ...
                  (h
                    .attr({
                      stroke:
                        i.color ||
                        (n
                          ? tv.parse('#ccd3ff').setOpacity(0.25).get()
                          : '#cccccc'),
                      'stroke-width': sP(i.width, 1)
                    })
          ...
          sb(this, 'afterDrawCrosshair', { e: t, point: e })
        }
        hideCrosshair () {
          this.cross && this.cross.hide(), sb(this, 'afterHideCrosshair')
        }
        update (t, e) {
          let i = this.chart
          ;(t = sT(this.userOptions, t)),
            this.destroy(!0),
            this.init(i, t),
            (i.isDirtyBox = !0),
            sP(e, !0) && i.redraw()
        ...
        class s {
          ...
          normalizeTimeTickInterval (t, e) {
            ...
            for (
              ...
              ((o = sW[(s = i[a])[0]]),
              (r = s[1]),
              !i[a + 1] || !(t <= (o * r[r.length - 1] + sW[i[a + 1][0]]) / 2));
              a++
            );
            o === sW.year && t < 5 * o && (r = [1, 2, 5])
            let n = sR(t / o, r, 'year' === s[0] ? Math.max(sz(t / o), 1) : 1)
      ...
      let sH = n,
        { addEvent: sX, normalizeTickInterval: sF, pick: sG } = $
      !(function (t) {
        function e () {
        ...
        function n (t) {
          ...
          if (e) {
            ...
            ;[
              ...
              for (o = e.length; o--; ) (e[o] || {}).id === t && sj(e, e[o])
            })
          }
        }
        function h (t) {
      ...
      class s5 {
        ...
        render () {
          ...
          if (
            (!t.chart.styledMode &&
              (v
                ? ((w.stroke = o || '#999999'),
                  (w['stroke-width'] = s3(e.width, 1)),
                  e.dashStyle && (w.dashstyle = e.dashStyle))
                : b &&
                  ((w.fill = o || '#e6e9ff'),
                  u && ((w.stroke = e.borderColor), (w['stroke-width'] = u)))),
            (l.zIndex = a),
            (M += '-' + a),
        ...
        renderLabel (t, e, i, s) {
          ...
          let h = e.xBounds || [e[0][1], e[1][1], i ? e[2][1] : e[0][1]],
            ...
            c = s_(l),
            p = sZ(h) - d
          n.align(t, !1, { x: d, y: c, width: p, height: sZ(l) - c }),
            (!n.alignValue || 'left' === n.alignValue || sK(a)) &&
              n.css({
                width:
                  (t.style?.width ||
                    (i && a
        ...
        getLabelText (t) {
          return sK(t.formatter) ? t.formatter.call(this) : t.text
        }
        destroy () {
          sQ(this.axis.plotLinesAndBands, this), delete this.axis, sJ(this)
        }
      }
      let { animObject: s6 } = tz,
        { format: s9 } = ee,
        { composed: s4, dateFormats: s8, doc: s7, isSafari: ot } = k,
        { distribute: oe } = en,
        {
          addEvent: oi,
          clamp: os,
      ...
      class ox {
        ...
        destroy () {
          this.label && (this.label = this.label.destroy()),
            ...
            this.renderer &&
              ((this.renderer = this.renderer.destroy()), or(this.container)),
        ...
        getClassName (t, e, i) {
          ...
          return [
            ...
            !i && 'highcharts-color-' + ou(t.colorIndex, o.colorIndex),
            r && r.className
          ]
            .filter(oc)
            .join(' ')
        ...
        getPlayingField () {
          let { body: t, documentElement: e } = s7,
        ...
        getPosition (t, e, i) {
          ...
          let T = !this.followPointer && ou(i.ttBelow, !d && !n === S),
        ...
        hide (t) {
          let e = this
          $.clearTimeout(this.hideTimer),
            (t = ou(t, this.options.hideDelay)),
            this.isHidden ||
              (this.hideTimer = om(function () {
                let i = e.getLabel()
                e.getLabel().animate(
                  { opacity: 0 },
                  {
        ...
        move (t, e, i, s) {
          let o = this,
            r = s6(!o.isHidden && o.options.animation),
        ...
        refresh (t, e) {
          ...
          r &&
            ...
            (n.points = a)),
            (this.len = a.length)
          let f = oc(h) ? s9(h, n, i) : l.call(n, this)
          n.points = void 0
          let m = n.series
          if (((this.distance = ou(m.tooltipOptions.distance, 16)), !1 === f))
            this.hide()
          else {
        ...
        renderSplit (t, e) {
          let i = this,
            ...
            y =
              i.outside && 'number' != typeof d
                ? s7.documentElement.getBoundingClientRect()
            ...
            if (!1 !== s && '' !== s) {
              let r = e[o - 1] || {
                ...
                f = (d.tt = (function (t, e, s) {
                  ...
                  if (!o) {
                    let t = { padding: u.padding, r: u.borderRadius }
                    c ||
                      ((t.fill = u.backgroundColor),
                      (t['stroke-width'] = u.borderWidth ?? 1)),
                      (o = v
                        .label(
                          '',
                          0,
                          0,
                          u[r ? 'headerShape' : 'shape'],
                          void 0,
                          void 0,
                          u.useHTML
                        )
                  ...
                  return (
                    ...
                    c ||
                      o
                        ...
                        .attr({
                          stroke:
                            u.borderColor || e.color || a.color || '#333333'
                        }),
                    o
                  )
                })(d.tt, r, s.toString())),
              ...
              let { anchorX: w, anchorY: M } = (function (t) {
                ...
                if (s) (e = Math.max(n + o, n)), (i = h + a / 2)
                  ...
                  ;(e = t.pos + os(o, -p, t.len + p)),
                    l.shouldShowTooltip(0, s.pos - h + r, { ignoreX: !0 }) &&
                      (i = s.pos + r)
                }
                return {
                  anchorX: (e = os(e, y.left - p, y.right + p)),
                  anchorY: i
                }
              })(r)
              if ('number' == typeof M) {
                let e = m.height + 1,
                  s = g ? g.call(i, x, e, r) : A(w, M, l, x)
                t.push({
                  align: g ? 0 : void 0,
                  anchorX: w,
                  anchorY: M,
          ...
          ot && b.attr({ opacity: 1 === b.opacity ? 0.999 : 1 })
        }
        drawTracker () {
        ...
        headerFooterFormatter (t, e) {
          ...
          return (
            on(this, 'headerFormatter', a, function (e) {
              if (
                (r &&
                  !n &&
                  ol(t.key) &&
                ...
                if (od(n)) {
                  let t = n
                  ;(s8[0] = e => i.chart.time.dateFormat(t, e)), (n = '%0')
                }
              ...
              i.chart.styledMode && (h = this.styledModeFormat(h)),
                (e.text = s9(h, t, this.chart))
            }),
            a.text || ''
          )
        }
        update (t) {
          this.destroy(), this.init(this.chart, op(!0, this.options, t))
        }
        updatePosition (t) {
          let {
              chart: e,
            ...
            u = (o.positioner || this.getPosition).call(this, h, n, t),
            g = k.doc,
          ...
          a &&
            i &&
            (o.positioner && ((u.x += l - s), (u.y += d - s)),
            (x = (o.borderWidth || 0) + 2 * s + 2),
            a.setSize(
              os(h + x, 0, g.documentElement.clientWidth) - 1,
              n + x,
              !1
            ),
            (1 !== c || 1 !== p) &&
              (oo(i, { transform: `scale(${c}, ${p})` }), (f *= c), (m *= p)),
            (f += l - u.x),
            (m += d - u.y)),
            this.move(Math.round(u.x), Math.round(u.y || 0), f, m)
        }
      }
      !(function (t) {
        t.compose = function (e) {
          og(s4, 'Core.Tooltip') &&
            oi(e, 'afterInit', function () {
              let e = this.chart
              e.options.tooltip &&
      ...
      class oR {
        ...
        applyOptions (t, e) {
          ...
          return (
            oT(this, (t = oR.prototype.optionsToObject.call(this, t))),
            (this.options = this.options ? oT(this.options, t) : t),
            t.group && delete this.group,
            t.dataLabels && delete this.dataLabels,
            s && (this.y = oR.prototype.getNestedProperty.call(this, s)),
            ...
            void 0 === this.x && i
              ...
              : oO(t.x) && i.options.relativeXValue
              ? (this.x = i.autoIncrement(t.x))
              : 'string' == typeof this.x &&
                (e ?? (e = i.chart.time.parse(this.x)), oO(e) && (this.x = e)),
        ...
        destroy () {
          if (!this.destroyed) {
            let t = this,
              ...
              o = i.hoverPoints,
              r = ob(t.series.chart.renderer.globalAnimation),
              a = () => {
                for (let e in ((t.graphic ||
                  t.graphics ||
                  t.dataLabel ||
                  t.dataLabels) &&
                  (oN(t), t.destroyElements()),
                t))
                  delete t[e]
              }
            t.legendItem && i.legend.destroyItem(t),
              o && (t.setState(), oS(o, t), o.length || (i.hoverPoints = null)),
              t === i.hoverPoint && t.onMouseOut(),
              s && s.enabled
                ? (this.animateBeforeDestroy(), oB(a, r.duration))
                : a(),
              i.pointCount--
          }
          this.destroyed = !0
        ...
        isValid () {
          return (oO(this.x) || this.x instanceof Date) && oO(this.y)
        }
        optionsToObject (t) {
          let e = this.series,
            i = e.options.keys,
          ...
          if (oO(t) || null === t) r[s[0]] = t
            ...
            for (
              ...
              (i && void 0 === t[n]) ||
                (s[h].indexOf('.') > 0
                  ? oR.prototype.setNestedProperty(r, t[n], s[h])
                  : (r[s[h]] = t[n])),
                n++,
                h++
          else
        ...
        resolveColor () {
          ...
          delete this.nonZonedColor,
            ...
            (this.colorIndex = oD(this.options.colorIndex, a)),
            (this.color = oD(this.options.color, s))
        }
        setNestedProperty (t, e, i) {
          return (
            i.split('.').reduce(function (t, i, s, o) {
              let r = o.length - 1 === s
              return (t[i] = r ? e : oE(t[i], !0) ? t[i] : {}), t[i]
            }, t),
            t
          )
        }
        ...
        update (t, e, i, s) {
          ...
          function d () {
            ...
            a.dataTable.setRow(c, o),
              (l.data[o] =
                oE(l.data[o], !0) || oE(t, !0) ? r.options : oD(t, l.data[o])),
        ...
        manageEvent (t) {
          let e = oI(this.series.options.point, this.options),
            i = e.events?.[t]
          oL(i) &&
          (!this.hcEvents?.[t] ||
            this.hcEvents?.[t]?.map(t => t.fn).indexOf(i) === -1)
            ? (this.importedUserEvent?.(),
              (this.importedUserEvent = ow(this, t, i)),
        ...
        setState (t, e) {
          let i = this.series,
            ...
            r = ov.plotOptions[i.type].marker && i.options.marker,
            a = r && !1 === r.enabled,
          ...
          if (
            ...
            if (
              ...
              ;(g = i.pointAttribs(this, t)),
                (f = oD(d.options.chart.animation, o.animation))
              let e = g.opacity
            ...
            u &&
              this.graphic.animate(
                u,
                oD(d.options.chart.animation, n.animation, r.animation)
              ),
              m && m.hide()
          } else
            t &&
              ...
              u &&
                (m
                  ? m[e ? 'animate' : 'attr']({ x: u.x, y: u.y })
                  : x &&
                    ((i.stateMarkerGraphic = m =
                      d.renderer
                        .symbol(x, u.x, u.y, u.width, u.height, oI(r, n))
                        .add(i.markerGroup)),
                    (m.currentSymbol = x))),
              !d.styledMode &&
                m &&
            ...
            ? (p || (i.halo = p = d.renderer.path().add(b.parentGroup)),
              ...
              p.attr({
                class:
                  ...
                  oD(this.colorIndex, i.colorIndex) +
              ...
              d.styledMode ||
                p.attr(
                  oT(
                    ...
                    t_.filterUserAttributes(y.attributes || {})
                  )
                ))
            : p?.point?.haloPath &&
              !p.point.destroyed &&
              p.animate({ d: p.point.haloPath(0) }, null, p.hide),
            oC(this, 'afterSetState', { state: t })
        }
        haloPath (t) {
          let e = this.pos()
          return e
      ...
      let oW = oR,
        { parse: oH } = tv,
        { charts: oX, composed: oF, isTouchDevice: oG } = k,
        {
          addEvent: oY,
          attr: oj,
          css: oU,
      ...
      class o2 {
        ...
        destroy () {
          ...
          this.eventsToUnbind.forEach(t => t()),
            (this.eventsToUnbind = []),
            !k.chartCount &&
              (o2.unbindDocumentMouseUp.forEach(t => t.unbind()),
              (o2.unbindDocumentMouseUp.length = 0),
              o2.unbindDocumentTouchEnd &&
                (o2.unbindDocumentTouchEnd = o2.unbindDocumentTouchEnd())),
        ...
        getSelectionMarkerAttrs (t, e) {
          ...
          return (
            oq(this, 'getSelectionMarkerAttrs', i, i => {
              let s
        ...
        drag (t) {
          ...
          if (
            ...
            ;(e.hasCartesianSeries || e.mapView) &&
              ...
              e.styledMode ||
                m.attr({ fill: a || oH('#334eff').setOpacity(0.25).get() })),
              m && m.attr(l),
              f && !m && c && e.pan(t, o)
          }
        }
        ...
        getSelectionBox (t) {
          ...
          return oq(this, 'getSelectionBox', e), e.result
        }
        drop (t) {
          let e
          ...
          if ((e && i.redraw(), s && t)) {
            ...
            oZ(i.index) && (this.selectionMarker = s.destroy())
          }
          i &&
            oZ(i.index) &&
            (oU(i.container, { cursor: i._cursor }),
        ...
        getChartCoordinatesFromPoint (t, e) {
          ...
          if (i && s) {
            let r = t.clientX ?? t.plotX ?? 0,
              a = t.plotY || 0
            return (
              t.isNode && o && oZ(o.x) && oZ(o.y) && ((r = o.x), (a = o.y)),
              e
          ...
          let a = [],
            n = function (t) {
              return (
                t.visible &&
                !(!o && t.directTouch) &&
                oQ(t.options.enableMouseTracking, !0)
              )
            },
            h = e,
            l,
          ...
          return (
            ...
            c &&
              (o && !h.noSharedTooltip
                ...
                : a.push(c)),
            oq(this, 'afterGetHoverData', (d = { hoverPoint: c })),
        ...
        normalize (t, e) {
          let i = t.touches,
            s = i
              ? i.length
                ? i.item(0)
                : oQ(i.changedTouches, t.changedTouches)[0]
              : t
        ...
        onContainerClick (t) {
          ...
          !e.cancelClick &&
            (i && this.inClass(s.target, 'highcharts-tracker')
              ? (oq(i.series, 'click', o$(s, { point: i })),
                e.hoverPoint && i.firePointEvent('click', s))
              : (o$(s, this.getCoordinates(s)),
        ...
        onContainerMouseLeave (t) {
          let { pointer: e } = oX[oQ(o2.hoverChartIndex, -1)] || {}
          ;(t = this.normalize(t)),
        ...
        onDocumentMouseUp (t) {
          oX[oQ(o2.hoverChartIndex, -1)]?.pointer?.drop(t)
        }
        pinch (t) {
          let e = this,
            ...
            n =
              ...
              ((e.inClass(t.target, 'highcharts-tracker') &&
                ...
                e.runChartClick),
            h = i.tooltip,
            l = 1 === a && oQ(h?.options.followTouchMove, !0)
          a > 1 ? (e.initiated = !0) : l && (e.initiated = !1),
            ...
            'touchstart' === t.type
              ...
              : o &&
                (oq(i, 'touchpan', { originalEvent: t, touches: r }, () => {
                  let e = t => {
                    let e = t[0],
                      i = t[1] || e
                    return {
        ...
        runPointActions (t, e, i) {
          ...
          this.unDocMouseMove ||
            ((this.unDocMouseMove = oY(
              s.container.ownerDocument,
              'mousemove',
              t => oX[o2.hoverChartIndex ?? -1]?.pointer?.onDocumentMouseMove(t)
            )),
            this.eventsToUnbind.push(this.unDocMouseMove)),
            s.axes.forEach(function (e) {
              let i
              let o = oQ((e.crosshair || {}).snap, !0)
              !o ||
                ((i = s.hoverPoint) && i.series[e.coll] === e) ||
                (i = oV(c, t => t.series && t.series[e.coll] === e)),
        ...
        setDOMEvents () {
          ...
          ;(t.onmousedown = this.onContainerMouseDown.bind(this)),
            ...
            this.eventsToUnbind.push(
              oY(t, 'mouseenter', this.onContainerMouseEnter.bind(this)),
              oY(t, 'mouseleave', this.onContainerMouseLeave.bind(this))
            ),
            o2.unbindDocumentMouseUp.some(t => t.doc === e) ||
              o2.unbindDocumentMouseUp.push({
                doc: e,
                unbind: oY(e, 'mouseup', this.onDocumentMouseUp.bind(this))
              })
          ...
          for (; i && 'BODY' !== i.tagName; )
            this.eventsToUnbind.push(
              ...
              (i = i.parentElement)
          this.eventsToUnbind.push(
            oY(t, 'touchstart', this.onContainerTouchStart.bind(this), {
              passive: !1
            }),
            oY(t, 'touchmove', this.onContainerTouchMove.bind(this), {
              passive: !1
            })
          ),
            o2.unbindDocumentTouchEnd ||
              (o2.unbindDocumentTouchEnd = oY(
                e,
                'touchend',
            ...
            oY(this.chart, 'redraw', this.setPointerCapture.bind(this))
        }
        setPointerCapture () {
          if (!oG) return
          let t = this.pointerCaptureEventsToUnbind,
            ...
            i = e.container,
            s =
              oQ(e.options.tooltip?.followTouchMove, !0) &&
          ...
          !this.hasPointerCapture && s
            ? (t.push(
              ...
              e.styledMode || oU(i, { 'touch-action': 'none' }),
        ...
        setHoverChartIndex (t) {
          let e = this.chart,
            i = k.charts[oQ(o2.hoverChartIndex, -1)]
          if (i && i !== e) {
            let s = { relatedTarget: e.container }
            t && !t?.relatedTarget && (t = { ...s, ...t }),
              i.pointer?.onContainerMouseLeave(t || s)
          }
          ;(i && i.mouseIsDown) || (o2.hoverChartIndex = e.index)
        }
        touch (t, e) {
          let i
        ...
        zoomOption (t) {
          let e = this.chart,
            ...
            o,
            r
          ;/touch/.test(t.type) && (s = oQ(e.zooming.pinchType, s)),
      ...
      ;(o2.unbindDocumentMouseUp = []),
        (function (t) {
          t.compose = function (e) {
            o0(oF, 'Core.Pointer') &&
              oY(e, 'beforeRender', function () {
                this.pointer = new t(this, this.options)
              })
          }
        })(o2 || (o2 = {}))
      let o3 = o2,
        { fireEvent: o5, isArray: o6, objectEach: o9, uniqueKey: o4 } = $,
        o8 = class {
          constructor (t = {}) {
            ;(this.autoId = !t.id),
              (this.columns = {}),
          ...
          setColumns (t, e, i) {
            ...
            o9(t, (t, e) => {
              ...
              i?.silent ||
                (o5(this, 'afterSetColumns'), (this.versionTag = o4()))
          }
          setRow (t, e = this.rowCount, i, s) {
            ...
            o9(t, (t, a) => {
              ...
              s?.silent || (o5(this, 'afterSetRows'), (this.versionTag = o4()))
          }
        },
        { extend: o7, merge: rt, pick: re } = $
      !(function (t) {
        function e (t, e, i) {
          ...
          if (m && !1 !== m.enabled && n) {
            let t = Math.min(re(m.radius, d), d)
            0 === l.indexOf('url') &&
              ((m = rt(m, { width: h, height: h })), (t = 0)),
              (s.symbol = f =
                c
                  .symbol(
                    l,
      ...
      let ri = d,
        { defaultOptions: rs } = tf,
        { extend: ro, extendClass: rr, merge: ra } = $
      !(function (t) {
        function e (e, i) {
          let s = rs.plotOptions || {},
            o = i.defaultOptions,
            r = i.prototype
          return (
            (r.type = e),
            r.pointClass || (r.pointClass = oW),
        ...
        ;(t.seriesTypes = k.seriesTypes),
          ...
          (t.seriesType = function (i, s, o, r, a) {
            let n = rs.plotOptions || {}
            if (
              ((s = s || ''),
              (n[i] = ra(n[s], o)),
              delete t.seriesTypes[i],
              e(i, rr(t.seriesTypes[s] || function () {}, r)),
              (t.seriesTypes[i].prototype.type = i),
              a)
            ) {
              class e extends oW {}
              ro(e.prototype, a), (t.seriesTypes[i].prototype.pointClass = e)
            }
            return t.seriesTypes[i]
          })
      })(c || (c = {}))
      let rn = c,
        { animObject: rh, setAnimation: rl } = tz,
        { defaultOptions: rd } = tf,
        { registerEventOptions: rc } = i0,
        { svg: rp, win: ru } = k,
        { seriesTypes: rg } = rn,
        {
          arrayMax: rf,
          ...
          find: rC,
          fireEvent: rA,
          getClosestDistance: rP,
          getNestedProperty: rL,
          insertItem: rO,
          isArray: rE,
          isNumber: rI,
          isString: rD,
      ...
      class rH {
        ...
        init (t, e) {
          let i
          rA(this, 'init', { options: e }),
            this.dataTable ?? (this.dataTable = new o8())
          let s = t.series
          ;(this.eventsToUnbind = []),
            (this.chart = t),
          ...
          ;((a && a.click) ||
            ...
            (this._i = rz(i && i._i, -1) + 1),
            (this.opacity = this.options.opacity),
            t.orderItems('series', rO(this, s)),
        ...
        is (t) {
          return rg[t] && this instanceof rg[t]
        }
        bindAxes () {
          let t
          let e = this,
            i = e.options,
            s = e.chart
          rA(this, 'bindAxes', null, function () {
            ;(e.axisTypes || []).forEach(function (o) {
              ;(s[o] || []).forEach(function (s) {
                ;(t = s.options),
                  (rz(i[o], 0) === s.index ||
                    (void 0 !== i[o] && i[o] === t.id)) &&
                    (rO(e, s.series), (e[o] = s), (s.isDirty = !0))
              }),
                e[o] || e.optionalAxis === o || rS(18, !0, s)
            })
          }),
            rA(this, 'afterBindAxes')
        }
        hasData () {
          return (
            (this.visible &&
        ...
        autoIncrement (t) {
          ...
          if (
            ((this.pointInterval = e =
              rz(this.pointInterval, i.pointInterval, 1)),
            o && rI(t) && (e *= t),
            s)
          ) {
            let t = r.toParts(a)
          ...
          return o && rI(t) ? a + e : ((this.xIncrement = a + e), a)
        }
        setDataSortingOptions () {
          ...
          rT(this, {
            ...
            rv(t.pointRange) || (t.pointRange = 1)
        }
        setOptions (t) {
          let e
          let i = this.chart,
          ...
          rA(this, 'setOptions', n)
          let h = n.plotOptions[this.type],
            l = o.plotOptions || {},
            d = l.series || {},
            c = rd.plotOptions[this.type] || {},
            p = l[this.type] || {}
          this.userOptions = n.userOptions
          let u = rB(h, s.series, p, r)
          ;(this.tooltipOptions = rB(
            rd.tooltip,
            rd.plotOptions.series?.tooltip,
            c?.tooltip,
          ...
          return (
            (u.negativeColor || u.negativeFillColor) &&
              !u.zones &&
              ((e = {
              ...
              a ||
                ((e.color = u.negativeColor),
                (e.fillColor = u.negativeFillColor)),
              g.push(e)),
            g.length &&
              rv(g[g.length - 1].value) &&
              g.push(a ? {} : { color: this.color, fillColor: this.fillColor }),
            rA(this, 'afterSetOptions', { options: u }),
            u
          )
        }
        getName () {
        ...
        getColor () {
          this.chart.styledMode
            ...
            : this.getCyclic(
                'color',
                this.options.color || rd.plotOptions[this.type].color,
        ...
        findPointIndex (t, e) {
          ...
          return (
            ...
            void 0 === o && rI(a) && (o = this.getColumn('x').indexOf(a, e)),
            -1 !== o &&
              void 0 !== o &&
              this.cropped &&
              (o = o >= this.cropStart ? o - this.cropStart : o),
            !s && rI(o) && n[o] && n[o].touched && (o = void 0),
            o
          )
        }
        updateData (t, e) {
          ...
          return (
            null === this.xIncrement &&
              u.length &&
              ((this.xIncrement = rf(u)), this.autoIncrement()),
            !0
          )
        }
        dataColumnKeys () {
        ...
        setData (t, e = !0, i, s) {
          ...
          if (
            ...
            for (
              rD(this.getColumn('y')[0]) && rS(14, !0, n),
                this.data = [],
              ...
              s &&
                ...
                (m[l - 1] < g || m[0] > f
                  ...
                  : e.getColumn(e.pointValKey || 'y').length &&
                    (m[0] < g || m[l - 1] > f) &&
                    ((x = (d = this.cropData(i, g, f)).modified),
                    (p = d.start),
                    (c = !0)))),
            (m = x.getColumn('x') || []),
            {
              ...
              cropped: c,
              cropStart: p,
              closestPointRange: rP(
                [h ? m.map(h.log2lin) : m],
                () => e.requireSorting && !y && rS(15, !1, e.chart)
              )
            }
          )
        }
        ...
        cropData (t, e, i) {
          ...
          return { modified: new o8({ columns: r }), start: h, end: l }
        }
        generatePoints () {
          let t = this.options,
          ...
          for (h && n && (this.options.keys = !1), x = 0; x < r; x++)
            (f = a + x),
              n
                ? (((m = new o(this, i.getRow(x, u) || [])).dataGroup =
                    this.groupMap[d + x]),
                  m.dataGroup?.options &&
                    ((m.options = m.dataGroup.options),
                    rT(m, m.dataGroup.options),
                    delete m.dataLabels))
                : ((m = y[f]),
          ...
          ;(this.data = y), (this.points = l), rA(this, 'afterGeneratePoints')
        }
        getXExtremes (t) {
          return { min: rm(t), max: rf(t) }
        }
        getExtremes (t, e) {
          let { xAxis: i, yAxis: s } = this,
            ...
            y = 0
          for (
            i && ((x = (g = i.getExtremes()).min), (y = g.max)), m = 0;
            m < a;
            m++
          )
            if (
              ((f = l[m]), u || ((l[m + c] || f) >= x && (l[m - c] || f) <= y))
            )
              for (let t of h) {
                let e = t[m]
                rI(e) && (e > 0 || !p) && d.push(e)
              }
          let b = { activeYData: d, dataMin: rm(d), dataMax: rf(d) }
          return rA(this, 'afterGetExtremes', { dataExtremes: b }), b
        }
        applyExtremes () {
        ...
        translate () {
          ...
          for (c = 0; c < a; c++) {
            ...
            ;(p = i.translate(x, !1, !1, !1, !0, n)),
              (a.plotX = rI(p) ? ry(m(p)) : void 0),
              e &&
                this.visible &&
                w &&
                w[x] &&
                ((g = this.getStackIndicator(g, x, this.index)),
                !a.isNull && g.key && (b = (y = w[x]).points[g.key]),
                y &&
                  rE(b) &&
                  ((k = b[0]),
                  (v = b[1]),
                  k === d && g.key === w[x].base && (k = rz(rI(l) ? l : o.min)),
                  o.positiveValuesOnly && rv(k) && k <= 0 && (k = void 0),
                  (a.total = a.stackTotal = rz(y.total)),
                  (a.percentage =
                    rv(a.y) && y.total ? (a.y / y.total) * 100 : void 0),
                  (a.stackY = v),
              ...
              (a.yBottom = rv(k) ? m(o.translate(k, !1, !0, !1, !0)) : void 0),
              this.dataModify && (v = this.dataModify.modifyValue(v, c)),
              rI(v) &&
                void 0 !== a.plotX &&
                (t = rI((t = o.translate(v, !1, !0, !1, !0))) ? m(t) : void 0),
              (a.plotY = t),
              (a.isInside = this.isPointInside(a)),
              (a.clientX = h ? ry(i.translate(x, !1, !1, !1, !0, n)) : p),
              (a.negative = (a.y || 0) < (l || 0)),
              a.isNull ||
                !1 === a.visible ||
                (void 0 !== u && (f = Math.min(f, Math.abs(p - u))), (u = p)),
              (a.zone = this.zones.length ? a.getZone() : void 0),
              !a.graphic && this.group && s && (a.isNew = !0)
          }
          ;(this.closestPointRangePx = f), rA(this, 'afterTranslate')
        }
        ...
        getClipBox () {
          let { chart: t, xAxis: e, yAxis: i } = this,
            { x: s, y: o, width: r, height: a } = rB(t.clipBox)
          return (
        ...
        afterAnimate () {
          this.setClip(),
            rN(this.chart.sharedClips, (t, e, i) => {
              t &&
          ...
          if (!1 !== p.enabled || this._hasPointMarkers)
            for (e = 0; e < t.length; e++)
              if (
                ...
                let t = rz(r.symbol, this.symbol, 'rect')
        ...
        pointAttribs (t, e) {
          ...
          return (
            ...
            (u = rz(
              ...
              h.lineWidth,
              u + rz(l.lineWidthPlus, h.lineWidthPlus, 0)
            )),
            (c = l.fillColor || h.fillColor || c),
            {
              ...
              'stroke-width': u,
              fill: c,
              opacity: (g = rz(l.opacity, h.opacity, g))
            }
          )
        }
        destroy (t) {
          ...
          let o = this,
            r = o.chart,
            a = /AppleWebKit\/533/.test(ru.navigator.userAgent),
            n = o.data || []
          for (
            rA(o, 'destroy', { keepEventsForUpdate: t }),
              this.removeEvents(t),
              (o.axisTypes || []).forEach(function (t) {
                ;(s = o[t]) &&
                  s.series &&
                  (rM(s.series, o), (s.isDirty = s.forceRedraw = !0))
              }),
          ...
          for (let t of o.zones) rk(t, void 0, !0)
        ...
        applyZones () {
          ...
          if (s.length && (i || t) && d && rI(d.min)) {
            ...
            if (
              (s.forEach(t => {
                ;(t.lineClip = []),
                  (t.translated = rx(d.toPixels(rz(t.value, e), !0) || 0, 0, p))
              }),
          ...
          if (
            ...
            return (function t (e, i, n, l) {
              ...
              !(function (t, e) {
                let i = t[o],
                  s = e[o],
                  a = rv(i) && rv(s) ? i - s : null,
                  n = t[r],
                  l = e[r],
                  d = rv(n) && rv(l) ? n - l : 0,
                  c = (h && e.marker?.radius) || 0
                ;(e.dist = Math.sqrt(((a && a * a) || 0) + d * d) - c),
                  (e.distX = rv(a) ? Math.abs(a) - c : Number.MAX_VALUE)
              })(e, d)
              let f =
        ...
        pointPlacementToXValue () {
          ...
          return (
            ...
            rI(i) ? i * (t.pointRange || e.pointRange) : 0
          )
        }
        isPointInside (t) {
        ...
        drawTracker () {
          let t = this,
            ...
            l = 'rgba(192,192,192,' + (rp ? 1e-4 : 0.002) + ')',
            d = t.tracker
          d
            ? d.attr({ d: s })
            : t.graph &&
        ...
        addPoint (t, e, i, s, o) {
          ...
          d.setRow(f, a, !0, { addColumns: !1 }),
            ...
            i &&
              (l[0] && l[0].remove
                ? l[0].remove(!1)
                : ([l, u, ...Object.values(d.getColumns())]
                    .filter(rv)
                    .forEach(t => {
                      t.shift()
                    }),
                  (d.rowCount -= 1),
                  rA(d, 'afterDeleteRows'))),
            !1 !== o && rA(this, 'addPoint', { point: f }),
            (this.isDirty = !0),
            (this.isDirtyData = !0),
            e && h.redraw(s)
        }
        ...
        remove (t, e, i, s) {
          ...
          !1 !== i ? rA(o, 'remove', null, a) : a()
        }
        update (t, e) {
          rA(this, 'update', { options: (t = rw(t, this.userOptions)) })
          let i = this,
            s = i.chart,
            o = i.userOptions,
          ...
          ;(u = u || r),
            g
              ? (p.push(
                ...
                t.data &&
                  (t.dataSorting && rT(i.options.dataSorting, t.dataSorting),
          ...
          if (rg[u]) {
            if (((f = u !== i.type), i.remove(!1, !1, !1, !0), f)) {
              if ((s.propFromSeries(), Object.setPrototypeOf))
                Object.setPrototypeOf(i, rg[u].prototype)
              else {
                let t = Object.hasOwnProperty.call(i, 'hcEvents') && i.hcEvents
                for (c in n) i[c] = void 0
                rT(i, rg[u].prototype), t ? (i.hcEvents = t) : delete i.hcEvents
              }
            }
          } else rS(17, !0, s, { missingModuleFor: u })
          if (
            (p.forEach(function (t) {
              i[t] = p[t]
            }),
        ...
        hasOptionChanged (t) {
          let e = this.chart,
            ...
            r = rz(s?.[this.type]?.[t], s?.series?.[t])
          return o && !rv(r) ? i !== o : i !== rz(r, i)
        }
        onMouseOver () {
          let t = this.chart,
            e = t.hoverSeries,
          ...
          i?.setHoverChartIndex(),
            ...
            this.options.events.mouseOver && rA(this, 'mouseOver'),
            this.setState('hover'),
            (t.hoverSeries = this)
        }
        onMouseOut () {
          ...
          ;(e.hoverSeries = null),
            s && s.onMouseOut(),
            this && t.events.mouseOut && rA(this, 'mouseOut'),
            i &&
              !this.stickyTracking &&
        ...
        drawLegendSymbol (t, e) {
          ri[this.options.legendSymbol || 'rectangle']?.call(this, t, e)
        }
      }
      ;(rH.defaultOptions = {
        lineWidth: 2,
        ...
        (rH.types = rn.seriesTypes),
        (rH.registerType = rn.registerSeriesType),
        rT(rH.prototype, {
        ...
        (rn.series = rH)
      let rX = rH,
        { animObject: rF, setAnimation: rG } = tz,
        { registerEventOptions: rY } = i0,
        { composed: rj, marginNames: rU } = k,
        { distribute: r$ } = en,
        { format: rV } = ee,
        {
          addEvent: rq,
      ...
      class r8 {
        constructor (t, e) {
          ;(this.allItems = []),
            ...
            e.enabled &&
              (this.render(),
              rY(this, e),
              rq(this.chart, 'endResize', function () {
                this.legend.positionCheckboxes()
              })),
            rq(this.chart, 'render', () => {
        ...
        update (t, e) {
          let i = this.chart
          this.setOptions(r2(!0, this.options, t)),
            'events' in this.options && rY(this, this.options),
            this.destroy(),
            (i.isDirtyLegend = i.isDirtyBox = !0),
            r3(e, !0) && i.redraw(),
            r0(this, 'afterUpdate', { redraw: e })
        }
        colorizeItem (t, e) {
          let i = t.color,
            {
          ...
          if (
            ((t instanceof rX || t instanceof oW) &&
          ...
          ;(t.color = i), r0(this, 'afterColorizeItem', { item: t, visible: e })
        }
        positionItems () {
        ...
        positionItem (t) {
          ...
          if (e && e.element) {
            ...
            e[rK(e.translateY) ? 'animate' : 'attr'](o, void 0, () => {
              r0(this, 'afterPositionItem', { item: t })
            })
          }
          n && ((n.x = i), (n.y = s))
        }
            ...
            this.allItems.forEach(function (o) {
              ...
              a &&
                ...
                r_(a, {
                  ...
                  top: r + 'px',
                  display:
                    this.proximate || (r > t - 6 && r < t + i - 6) ? '' : 'none'
                }))
            }, this))
        }
        renderTitle () {
        ...
        renderItem (t) {
          ...
          !y &&
            ...
            i.styledMode || y.css(r2(t.visible ? h : l)),
            ...
            !this.baseline &&
              ...
              (this.symbolHeight = r3(o.symbolHeight, this.fontMetrics.f)),
              o.squareSymbol &&
                ((this.symbolWidth = r3(
                  o.symbolWidth,
        ...
        getAllItems () {
          ...
          return (
            this.chart.series.forEach(function (e) {
              let i = e && e.options
              e &&
                r3(i.showInLegend, !rK(i.linkedTo) && void 0, !0) &&
                (t = t.concat(
                  (e.legendItem || {}).labels ||
                    ('point' === i.legendType ? e.data : e)
                ))
            }),
            r0(this, 'afterGetAllItems', { allItems: t }),
            t
          )
        }
        getAlignment () {
        ...
        proximatePositions () {
          ...
          r$(i, e.plotHeight)))
            (t = o.item.legendItem || {}),
              r1(o.pos) && (t.y = e.plotTop - e.spacing[0] + o.pos)
        }
        render () {
          let t = this.chart,
            e = t.renderer,
          ...
          ;(this.itemX = s),
            ...
            (this.offsetWidth = 0),
            (this.lastItemY = 0),
            (this.widthOption = r6(i.width, t.spacingBox.width - s)),
          ...
          return (
            ...
            t && b > 0 && t > b && !1 !== l.enabled
              ? ((this.clipHeight = m =
                ...
                (this.currentPage = r3(this.currentPage, 1)),
                (this.fullHeight = t),
                u.forEach((t, e) => {
        ...
        scroll (t, e) {
          ...
          l > o && (l = o),
            l > 0 &&
              ...
              r4(() => {
                r0(this, 'afterScroll', { currentPage: l })
              }, rF(r3(e, i.renderer.globalAnimation, !0)).duration))
        }
        setItemEvents (t, e, i) {
          let s = this,
            o = t.legendItem || {},
            ...
            i &&
              i
                ...
                .on('mouseout', function () {
                  s.chart.styledMode ||
                    e.css(r2(t.visible ? s.itemStyle : s.itemHiddenStyle)),
                    c(''),
                    r.removeClass(h),
                    t.setState()
                })
                .on('click', function (e) {
                  ...
                  r.removeClass(h),
                    r0(s, 'itemClick', { browserEvent: e, legendItem: t }, i),
                    a
                      ? t.firePointEvent('legendItemClick', { browserEvent: e })
                      : n && r0(t, 'legendItemClick', { browserEvent: e })
                })
        }
        createCheckboxForItem (t) {
          ;(t.checkbox = rZ(
            ...
            rq(t.checkbox, 'click', function (e) {
              let i = e.target
              r0(
                t.series || t,
                'checkboxClick',
      ...
      !(function (t) {
        t.compose = function (e) {
          r5(rj, 'Core.Legend') &&
            rq(e, 'beforeMargins', function () {
              this.legend = new t(this, this.options.legend)
            })
        }
      })(r8 || (r8 = {}))
      let r7 = r8,
        { animate: at, animObject: ae, setAnimation: ai } = tz,
        { defaultOptions: as } = tf,
        { numberFormat: ao } = ee,
        { registerEventOptions: ar } = i0,
        { charts: aa, doc: an, marginNames: ah, svg: al, win: ad } = k,
        { seriesTypes: ac } = rn,
        {
          addEvent: ap,
          attr: au,
      ...
      class aH {
        ...
        constructor (t, e, i) {
          this.sharedClips = {}
          let s = [...arguments]
          ;(aL(t) || t.nodeName) && (this.renderTo = s.shift()),
            this.init(s[0], s[1])
        }
        setZoomOptions () {
          ...
          this.zooming = {
            ...e,
            type: aI(t.zoomType, e.type),
            key: aI(t.zoomKey, e.key),
            pinchType: aI(t.pinchType, e.pinchType),
            singleTouch: aI(t.zoomBySingleTouch, e.singleTouch, !1),
            resetButton: aO(e.resetButton, t.resetZoomButton)
          }
        }
        init (t, e) {
          aM(this, 'init', { args: arguments }, function () {
            let i = aO(as, t),
              s = i.chart,
              o = this.renderTo || s.renderTo
            ;(this.userOptions = ak({}, t)),
              (this.renderTo = aL(o) ? an.getElementById(o) : o) ||
                av(13, !0, this),
              (this.margin = []),
              (this.spacing = []),
              ...
              (this.time = new tl(ak(i.time || {}, { locale: this.locale }))),
              (i.time = this.time.options),
              (this.numberFormatter = (s.numberFormatter || ao).bind(this)),
              (this.styledMode = s.styledMode),
              (this.hasCartesianSeries = s.showAxes),
              (this.index = aa.length),
              aa.push(this),
              k.chartCount++,
              ar(this, s),
              (this.xAxis = []),
        ...
        initSeries (t) {
          let e = this.options.chart,
            i = t.type || e.type,
            s = ac[i]
          s || av(17, !0, this, { missingModuleFor: i })
          let o = new s()
        ...
        orderItems (t, e = 0) {
          let i = this[t],
            s = (this.options[t] = az(this.options[t]).slice()),
            o = (this.userOptions[t] = this.userOptions[t]
              ? az(this.userOptions[t]).slice()
              : [])
          if ((this.hasRendered && (s.splice(e), o.splice(e)), i))
            for (let t = e, r = i.length; t < r; ++t) {
              ...
              e &&
                ((e.index = t),
                e instanceof rX && (e.name = e.getName()),
        ...
        isInsidePlot (t, e, i = {}) {
          ...
          return aM(this, 'afterIsInsidePlot', g), g.isInsidePlot
        }
        redraw (t) {
          aM(this, 'beforeRedraw')
          ...
          i.forEach(function (t) {
            t.isDirty &&
              ...
              t.isDirtyData && aM(t, 'updatedData')
          }),
            u &&
              o &&
              o.options.enabled &&
            ...
            e.forEach(function (t) {
              ...
              t.extKey !== e &&
                ((t.extKey = e),
                h.push(function () {
                  aM(t, 'afterSetExtremes', ak(t.eventArgs, t.getExtremes())),
                    delete t.eventArgs
                })),
                (p || d) && t.redraw()
            }),
        ...
        get (t) {
          ...
          let s = aw(this.axes, i) || aw(this.series, i)
          for (let t = 0; !s && t < e.length; t++) s = aw(e[t].points || [], i)
          return s
        }
        createAxes () {
          let t = this.userOptions
          for (let e of (aM(this, 'createAxes'), ['xAxis', 'yAxis']))
            for (let i of (t[e] = az(t[e] || {}))) new sB(this, i, e)
          aM(this, 'afterCreateAxes')
        }
        getSelectedPoints () {
          return this.series.reduce(
            (t, e) => (
              e.getPointsCollection().forEach(e => {
                aI(e.selectedStaging, e.selected) && t.push(e)
              }),
              t
            ),
            []
        ...
        applyDescription (t, e) {
          let i = this,
            s = (this.options[t] = aO(this.options[t], e)),
            o = this[t]
        ...
        layOutTitles (t = !0) {
          ...
          ;['title', 'subtitle', 'caption'].forEach(t => {
            let i = this[t],
              ...
              n = i?.textPxLength || 0
            if (i && r) {
              aM(this, 'layOutTitle', { alignTo: a, key: t, textPxLength: n })
              ...
              if (
                ...
                i
                  ...
                  .attr({
                    ...
                    scaleX: f,
                    scaleY: f,
                    'transform-origin': `${a.x + n * f * aS(m.align)} ${l}`
                  }),
                !r.floating)
              ) {
                let t = y * (y < 1.2 * l ? 1 : f)
        ...
        getContainerBox () {
          let t = [].map.call(this.renderTo.children, t => {
            ...
            e = {
              width: aT(this.renderTo, 'width', !0) || 0,
              height: aT(this.renderTo, 'height', !0) || 0
            }
          return (
        ...
        getChartSize () {
          ...
          ;(this.chartWidth = Math.max(0, e || s.width || 600)),
            (this.chartHeight = Math.max(
              0,
              aB(i, this.chartWidth) || (o ? 400 : s.height)
            )),
            (this.containerBox = s)
        }
        temporaryDisplay (t) {
          ...
          if (t)
            for (; e && e.style; )
              e.hcOrigStyle && (af(e, e.hcOrigStyle), delete e.hcOrigStyle),
                e.hcOrigDetached &&
                  (an.body.removeChild(e), (e.hcOrigDetached = !1)),
                (e = e.parentNode)
          else
            for (
              ;
              ...
              (an.body.contains(e) ||
                e.parentNode ||
                ((e.hcOrigDetached = !0), an.body.appendChild(e)),
              ('none' === aT(e, 'display', !1) || e.hcOricDetached) &&
                ((e.hcOrigStyle = {
        ...
        getContainer () {
          ...
          let e = this.options,
            ...
            r = this.renderTo,
            a = aD(au(r, s))
          aA(a) && aa[a] && aa[a].hasRendered && aa[a].destroy(),
            au(r, s, this.index),
          ...
          let l = ag('div', { id: o }, t, r)
          ;(this.container = l),
            this.getChartSize(),
            h === this.chartWidth ||
              ((h = this.chartWidth),
              this.styledMode ||
                af(l, { width: aI(i.style?.width, h + 'px') })),
            (this.containerBox = this.getContainerBox()),
            (this._cursor = l.style.cursor)
          let d = i.renderer || !al ? ei.getRendererType(i.renderer) : iB
          if (
            ((this.renderer = new d(
              l,
              h,
        ...
        setChartSize (t) {
          ...
          ;(this.plotLeft = e = Math.round(this.plotLeft)),
            ...
            t ||
              ...
              l.alignElements()),
            aM(this, 'afterSetChartSize', { skipAxes: t })
        }
        resetMargins () {
          aM(this, 'resetMargins')
          let t = this,
            e = t.options.chart,
          ...
          ;['margin', 'spacing'].forEach(function (i) {
            ...
            ah.forEach(function (e, i) {
              t[e] = aI(t.margin[i], t.spacing[i])
            }),
        ...
        linkSeries (t) {
          ...
          i.forEach(function (t) {
            ...
            aM(this, 'afterLinkSeries', { isUpdating: t })
        }
        renderSeries () {
          this.series.forEach(function (t) {
          ...
          t)) {
            ...
            if (
              ...
              if (
                (s.destroy(),
                o &&
                  aI(i.reserveSpace, !aA(t.crossing)) &&
                  (r =
                    o.getBBox().height +
                    i.distance +
        ...
        addCredits (t) {
          ...
          i.enabled &&
            ...
            ((this.credits = this.renderer
              ...
              .on('click', function () {
                i.href && (ad.location.href = i.href)
              })
        ...
        destroy () {
          ...
          for (
            aM(e, 'destroy'),
              e.renderer.forExport ? ab(aa, e) : (aa[e.index] = void 0),
              k.chartCount--,
          ...
          ;[
            ...
            o && ((o.innerHTML = t_.emptyHTML), aN(o), r && ay(o)),
            aE(e, function (t, i) {
              delete e[i]
            })
        }
        ...
        addSeries (t, e, i) {
          ...
          return (
            t &&
              ((e = aI(e, !0)),
              aM(o, 'addSeries', { options: t }, function () {
                ;(s = o.initSeries(t)),
                  (o.isDirtyLegend = !0),
                  o.linkSeries(),
                  s.enabledDataSorting && s.setData(t.data, !1),
                  aM(o, 'afterAddSeries', { series: s }),
                  e && o.redraw(i)
              })),
            s
          )
        ...
        createAxis (t, e) {
          let i = new sB(this, e.axis, t)
          return aI(e.redraw, !0) && this.redraw(e.animation), i
        }
        showLoading (t) {
          let e = this,
            i = e.options,
          ...
          r ||
            ...
            a ||
              ((e.loadingSpan = a =
                ag('span', { className: 'highcharts-loading-inner' }, null, r)),
              ap(e, 'redraw', o)),
            (r.className = 'highcharts-loading'),
            t_.setElementHTML(a, aI(t, i.lang.loading, '')),
            e.styledMode ||
              (af(r, ak(s.style, { zIndex: 10 })),
              af(a, s.labelStyle),
              e.loadingShown ||
                (af(r, { opacity: 0, display: '' }),
                at(
                  r,
        ...
        update (t, e, i, s) {
                ...
                (az(t[e]).forEach(function (t, s) {
                  ...
                  r && (o = n.get(t.id)),
                    !o &&
                      n[e] &&
                      (o = n[e][aI(t.index, s)]) &&
                      ((r && am(o.options.id)) || o.options.isInternal) &&
                      (o = void 0),
                    o &&
                      o.coll === e &&
          ...
          let p = c && c.width,
            u = c && (aL(c.height) ? aB(c.height, p || n.chartWidth) : c.height)
          a || (aA(p) && p !== n.chartWidth) || (aA(u) && u !== n.chartHeight)
            ? n.setSize(p, u, s)
            : aI(e, !0) && n.redraw(s),
            aM(n, 'afterUpdate', { options: t, redraw: e, animation: s })
        }
        setSubtitle (t, e) {
        ...
        showResetZoom () {
          ...
          aM(this, 'beforeShowResetZoom', null, function () {
            ...
            aM(this, 'afterShowResetZoom')
        }
        zoomOut () {
          aM(this, 'selection', { resetSelection: !0 }, () =>
        ...
        transform (t) {
          ...
          for (let t of (this.hoverPoints?.forEach(t => t.setState()), e)) {
            ...
            let T = t.toValue(M, !0) + (r || t.isOrdinal ? 0 : g * S),
              C =
                t.toValue(M + u / k, !0) - (r || t.isOrdinal ? 0 : g * S || 0),
              A = t.allExtremes
            if (
              (T > C && ([T, C] = [C, T]),
            ...
            let {
              ...
              W = B - R * (am(I) ? 0 : f.minPadding),
              H = N + R * (am(D) ? 0 : f.maxPadding),
      ...
      ak(aH.prototype, {
        callbacks: [],
        collectionsWithInit: {
          xAxis: [aH.prototype.addAxis, [!0]],
          yAxis: [aH.prototype.addAxis, [!1]],
          series: [aH.prototype.addSeries]
        },
      ...
      function aZ () {
        ...
        ;(this.scrollablePixelsX || this.scrollablePixelsY) &&
          !t &&
          (this.scrollablePlotArea = t = new aK(this)),
          t?.applyFixed()
      }
      function a_ () {
      ...
      class aK {
        static compose (t, e, i) {
          aq(aF, this.compose) &&
            (aG(t, 'afterInit', a_),
            aG(e, 'afterSetChartSize', t => this.afterSetSize(t.target, t)),
            aG(e, 'render', aZ),
            aG(i, 'show', a_))
        }
          ...
          if (
            ...
            (r
              ? ((t.scrollablePixelsX = i = Math.max(0, r - t.chartWidth)),
                i &&
                  ((t.scrollablePlotBox = aV(t.plotBox)),
        ...
        constructor (t) {
          ...
          t.scrollablePixelsX && (a.overflowX = 'auto'),
            ...
            (this.chart = t)
          let n = (this.parentDiv = aY(
              'div',
              { className: 'highcharts-scrolling-parent' },
              { position: 'relative' },
              t.renderTo
            )),
            h = (this.scrollingContainer = aY(
              'div',
              { className: 'highcharts-scrolling' },
              a,
              n
            )),
            l = (this.innerContainer = aY(
              'div',
          ...
          ;(this.mask = c
            ...
            aj(t.renderTo, { overflow: 'visible' }),
            aG(t, 'afterShowResetZoom', r),
            aG(t, 'afterApplyDrilldown', r),
            aG(t, 'afterLayOutTitles', r),
            aG(h, 'scroll', () => {
        ...
        applyFixed () {
          let {
            ...
            { scrollPositionX: g = 0, scrollPositionY: f = 0 } =
              t.options.chart.scrollablePlotArea || {},
            m = r + p,
            x = a + u
          e.setSize(r, a),
        ...
        a6 = class {
          ...
          render (t) {
            let e = this.axis.chart,
              i = this.options,
              s = i.format,
              o = s ? aJ(s, this, e) : i.formatter.call(this)
            ...
            ;(this.label.labelrank = e.plotSizeY), a1(this, 'afterRender')
          }
          setOffset (t, e, i, s, o, r) {
            ...
            if (h && p) {
              let t = h.getBBox(void 0, 0),
                e = h.padding,
                i = 'justify' === a5(l.overflow, 'justify'),
                s
              ;(a.x = l.x || 0), (a.y = l.y || 0)
              ...
              ;(p.x -= o),
                ...
                i &&
                  aQ.prototype.justifyDataLabel.call(
                    n,
                    h,
                    a,
                    h.alignAttr,
                ...
                h.attr({
                  ...
                  y: h.alignAttr.y,
                  rotation: l.rotation,
                  rotationOriginX: t.width * a2(l.textAlign || 'center'),
            ...
            a1(this, 'afterSetOffset', { xOffset: t, width: e })
          }
          adjustStackPosition ({ labelBox: t, verticalAlign: e, textAlign: i }) {
            return {
              x: t.width / 2 + (t.width / 2) * (2 * a2(i) - 1),
              y: (t.height / 2) * 2 * (1 - a2(e))
            }
          }
          getStackBox (t) {
            let e = this.axis,
              ...
              h = e.stacking.usePercentage ? 100 : a5(s, this.total, 0),
              l = e.toPixels(h),
              d = t.xAxis || i.xAxis[0],
              c = a5(o, d.translate(this.x)) + r,
              p = Math.abs(
                l -
                  e.toPixels(
                    n ||
      ...
      function nh () {
        this.stacking || (this.stacking = new ng(this))
      }
      function nl (t, e, i, s) {
        return (
          !nt(t) || t.x !== e || (s && t.stackKey !== s)
      ...
      function np (t) {
        ;(this.is('column') || this.is('columnrange')) &&
          (this.options.centerInCategory && this.chart.series.length > 1
            ? a4.setStackedPoints.call(this, t, 'group')
      ...
      function nu (t, e) {
        ...
        for (k.stacksTouched += 1, h = 0; h < u; h++) {
          ...
          ;(n = (i = this.getStackIndicator(i, e, this.index)).key || ''),
            w[(a = (s = v && g < (m ? 0 : f)) ? b : y)] || (w[a] = {}),
            w[a][e] ||
              (M[a]?.[e]
                ? ((w[a][e] = M[a][e]), (w[a][e].total = null))
                : (w[a][e] = new a6(t, t.options.stackLabels, !!s, e, x))),
            (o = w[a][e]),
            null !== u
              ? ((o.points[n] = o.points[this.index] = [nr(o.cumulative, m)]),
                nt(o.cumulative) || (o.base = n),
          ...
          'percent' === l
            ? ((r = s ? y : b),
              (S =
                v && w[r]?.[e]
                  ? ((r = w[r][e]).total =
                      Math.max(r.total || 0, S) + Math.abs(g))
                  : a7(S + Math.abs(g))))
            : 'group' === l
            ? ns(u) && S++
            : (S = a7(S + g)),
            'group' === l
              ? (o.cumulative = (S || 1) - 1)
              : (o.cumulative = a7(nr(o.cumulative, m) + g)),
            (o.total = S),
            null !== u &&
      ...
      class ng {
        ...
        resetStacks () {
          no(this.stacks, t => {
            no(t, (e, i) => {
              ns(e.touched) && e.touched < this.stacksTouched
        ...
        renderStackTotals () {
          let t = this.axis,
            ...
            i = e.renderer,
            s = this.stacks,
            o = a9(e, t.options.stackLabels?.animation || !1),
      ...
      ;(p || (p = {})).compose = function (t, e, i) {
        ...
        s.getStacks ||
          ...
          a8(t, 'destroy', nn),
          (s.getStacks = na),
          (o.getStackIndicator = nl),
          (o.modifyStacks = nd),
          (o.percentStacker = nc),
          (o.setGroupedPoints = np),
          (o.setStackedPoints = nu))
      }
      let nf = p,
        { defined: nm, merge: nx, isObject: ny } = $
      class nb extends rX {
        drawGraph () {
          let t = this.options,
        ...
        getGraphPath (t, e, i) {
          ...
          return (
            ...
            (t = this.getValidPoints(
              ...
              ;(l.leftCliff || (g && g.rightCliff)) && !i && (n = !0),
                f && !nm(e) && d > 0
                  ? (n = !o.connectNulls)
                  : f && !e
                  ? (n = !0)
      ...
      ;(nb.defaultOptions = nx(rX.defaultOptions, {
        legendSymbol: 'lineMarker'
      })),
        rn.registerSeriesType('line', nb)
      let {
          seriesTypes: { line: nv }
        } = rn,
        { extend: nk, merge: nw, objectEach: nM, pick: nS } = $
      class nT extends nv {
        drawGraph () {
        ...
        getGraphPath (t) {
          let e, i, s
          let o = nv.prototype.getGraphPath,
            r = this.options,
            a = r.stacking,
            n = this.yAxis,
            h = [],
            ...
            a ||
              (t[o].leftCliff =
                ...
                t[o].rightNull =
                  void 0),
              (i = t[o].isNull),
              (e = nS(t[o].rectPlotX, t[o].plotX)),
              (s = a ? nS(t[o].yBottom, u) : u),
              (i && !g) ||
                (g || f(o, o - 1, 'left'),
                (i && !a && g) ||
      ...
      ;(nT.defaultOptions = nw(nv.defaultOptions, {
        threshold: 0,
        legendSymbol: 'areaMarker'
      })),
        nk(nT.prototype, { singleStacks: !1 }),
        rn.registerSeriesType('area', nT)
      let { line: nC } = rn.seriesTypes,
        { merge: nA, pick: nP } = $
      class nL extends nC {
        getPointSpline (t, e, i) {
          ...
          let p = [
            'C',
            nP(l.rightContX, l.plotX, 0),
            nP(l.rightContY, l.plotY, 0),
            nP(s, n, 0),
            nP(o, h, 0),
            n,
            h
      ...
      ;(nL.defaultOptions = nA(nC.defaultOptions)),
        rn.registerSeriesType('spline', nL)
      let nO = nL,
        {
          area: nE,
          area: { prototype: nI }
        ...
        { extend: nD, merge: nB } = $
      class nN extends nO {}
      ;(nN.defaultOptions = nB(nO.defaultOptions, nE.defaultOptions)),
        nD(nN.prototype, {
          getGraphPath: nI.getGraphPath,
          getStackPoints: nI.getStackPoints,
          drawGraph: nI.drawGraph
        }),
        rn.registerSeriesType('areaspline', nN)
      let { animObject: nz } = tz,
        { parse: nR } = tv,
        { noop: nW } = k,
        {
          clamp: nH,
      ...
      class nZ extends rX {
        animate (t) {
          ...
          t && h
            ? ((d.scaleY = 0.001),
              (i = nH(o.toPixels(n.threshold || 0), r, r + o.len)),
              l
        ...
        getColumnMetrics () {
          ...
          let l = Math.min(
            ...
            p = Math.min(
              ...
              nV(e.pointWidth, c * (1 - 2 * e.pointPadding))
            ),
        ...
        crispCol (t, e, i, s) {
          ...
          return (
            (s = nX(e + s, o, r) - (e = nX(e, o, r))),
            this.options.crisp && (i = nX(t + i, o) - (t = nX(t, o))),
        ...
        adjustForMissingColumns (t, e, i, s) {
          if (!i.isNull && s.columnCount > 1) {
            let o = this.xAxis.series.filter(t => t.visible).map(t => t.index),
              r = 0,
              a = 0
            nq(this.xAxis.stacking?.stacks, t => {
              let e =
        ...
        translate () {
          let t = this,
            ...
            o = (t.borderWidth = nV(i.borderWidth, s ? 0 : 1)),
            r = t.xAxis,
            a = t.yAxis,
            n = i.threshold,
            h = nV(i.minPointLength, 5),
          ...
          i.pointPadding && i.crisp && (f = Math.ceil(f)),
            rX.prototype.translate.apply(t),
            t.points.forEach(function (s) {
              let o = nV(s.yBottom, g),
                m = 999 + Math.abs(o),
                x = s.plotX || 0,
                y = nH(s.plotY, -m, a.len + m),
                b,
                v = Math.min(y, o),
                k = Math.max(y, o) - v,
                w = d,
        ...
        pointAttribs (t, e) {
          ...
          t &&
            ...
            e &&
              ...
              (l =
                a.color ||
                (void 0 !== h && nR(l).brighten(a.brightness).get()) ||
                l),
              (d = a[o] || d),
              (p = a[r] || p),
              (c = a.dashStyle || c),
              (u = nV(a.opacity, u)))
          let g = { fill: l, stroke: d, 'stroke-width': p, opacity: u }
        ...
        remove () {
          ...
          e.hasRendered &&
            ...
            rX.prototype.remove.apply(t, arguments)
        }
      }
      ;(nZ.defaultOptions = n$(rX.defaultOptions, {
        borderRadius: 3,
        centerInCategory: !1,
        groupPadding: 0.2,
        marker: null,
        ...
        rn.registerSeriesType('column', nZ)
      let n_ = nZ,
        { getDeferredAnimation: nK } = tz,
        { format: nJ } = ee,
        {
          defined: nQ,
          extend: n0,
      ...
      !(function (t) {
        ...
        function i (t, e, i, s, o) {
          let { chart: r, enabledDataSorting: a } = this,
            ...
            p = 0 === d && 'justify' === n4(i.overflow, a ? 'none' : 'justify'),
            u =
              this.visible &&
              !1 !== t.visible &&
              nQ(h) &&
              (t.series.forceDL ||
                (a && !p) ||
                c ||
                (n4(i.inside, !!this.options.stacking) &&
                  s &&
          ...
          if (u && g) {
            ...
            if (
              ((s = n0(
                { x: g[0], y: Math.round(g[1]), width: 0, height: 0 },
                s || {}
              )),
              'plotEdges' === i.alignTo &&
                this.isCartesian &&
              ...
              n0(i, { width: h.width, height: h.height }),
              (f = s),
              a && this.xAxis && !p && this.setDataLabelStartPos(t, e, o, c, f),
              e.align(n6(i, { width: l.width, height: l.height }), !1, s, !1),
              (e.alignAttr.x += n2(i.align) * (l.width - h.width)),
              (e.alignAttr.y += n2(i.verticalAlign) * (l.height - h.height)),
            ...
            i.shape &&
              !d &&
              e[o ? 'attr' : 'animate']({ anchorX: g[0], anchorY: g[1] })
          }
          o && a && (e.placed = !1),
            u || (a && !p)
              ? (e.show(), (e.placed = !0))
        ...
        function r (t) {
          ...
          let i = this,
            ...
            d = r.getContrast((n5(l) && l) || (n5(a) && a) || '#000000'),
            c = h(i),
            { animation: p, defer: u } = c[0],
            g = u ? nK(s, p, i) : { defer: 0, duration: 0 }
          n1(this, 'drawDataLabels'),
            i.hasDataLabels?.() &&
              ((e = this.initDataLabels(g)),
              t.forEach(t => {
                let a = t.dataLabels || []
                n7(n(c, t.dlOptions || t.options?.dataLabels)).forEach(
                  (n, h) => {
                    let l =
                        n.enabled &&
                      ...
                      k
                    l &&
                      ((m = nQ((f = n4(n[t.formatPrefix + 'Format'], n.format)))
                        ? nJ(f, t, s)
          ...
          return (
            ...
            (m = i.y + l + u) < 0 &&
              ('bottom' === h && f >= 0
                ...
                : (f -= m),
              (x = !0)),
            (m = (i.y || 0) + s.height - l + u) > a.plotHeight &&
              ('top' === h && f <= 0
        ...
        function l (t, e, i, s, o) {
          ...
          ;(e.startXPos = a ? o.x : h ? -l - c : n.width - l + c),
            ...
            r.hasRendered &&
              (i && e.attr({ x: e.startXPos, y: e.startYPos }), (e.placed = !0))
        }
        t.compose = function (t) {
          let n = t.prototype
          n.initDataLabels ||
      ...
      let ht = u,
        { composed: he } = k,
        { series: hi } = rn,
        { merge: hs, pick: ho, pushUnique: hr } = $
      !(function (t) {
        function e (t, e, i, s, o) {
          let r = this.chart.inverted,
            ...
            d = ho(t.below, t.plotY > ho(this.translatedThreshold, h)),
            c = ho(i.inside, !!this.options.stacking)
          if (l) {
            if (((s = hs(l)), !('allow' === i.overflow && !1 === i.crop))) {
          ...
          ;(i.align = ho(i.align, !r || c ? 'center' : d ? 'right' : 'left')),
            (i.verticalAlign = ho(
              i.verticalAlign,
              r || c ? 'middle' : d ? 'top' : 'bottom'
            )),
            hi.prototype.alignDataLabel.call(this, t, e, i, s, o),
            i.inside && t.contrastColor && e.css({ color: t.contrastColor })
        }
        t.compose = function (t) {
          ht.compose(hi),
            hr(he, 'ColumnDataLabel') && (t.prototype.alignDataLabel = e)
        }
      })(g || (g = {}))
      let ha = g,
        { extend: hn, merge: hh } = $
      class hl extends n_ {}
      ;(hl.defaultOptions = hh(n_.defaultOptions, {})),
        hn(hl.prototype, { inverted: !0 }),
        rn.registerSeriesType('bar', hl)
      let { column: hd, line: hc } = rn.seriesTypes,
        { addEvent: hp, extend: hu, merge: hg } = $
      class hf extends hc {
        applyJitter () {
          let t = this,
      ...
      ;(hf.defaultOptions = hg(hc.defaultOptions, {
        lineWidth: 0,
        ...
        hp(hf, 'afterTranslate', function () {
          this.applyJitter()
        }),
        rn.registerSeriesType('scatter', hf)
      let { deg2rad: hm } = k,
        { fireEvent: hx, isNumber: hy, pick: hb, relativeLength: hv } = $
      !(function (t) {
        ;(t.getCenter = function () {
          ...
          let u = [
            hb(r?.[0], '50%'),
            hb(r?.[1], '50%'),
            hb(l && l < 0 ? void 0 : t.size, '100%'),
            hb(d && d < 0 ? void 0 : t.innerSize || 0, '0%')
          ]
          for (
            !e.angular || this instanceof rX || (u[3] = 0), c = 0;
            c < 4;
            ++c
          )
            (p = u[c]),
              (h = c < 2 || (2 === c && /%$/.test(p))),
              (u[c] = hv(p, [s, o, a, u[2]][c]) + (h ? i : 0))
          return (
            u[3] > u[2] && (u[3] = u[2]),
            hy(n) && 2 * n < u[2] && n > 0 && (u[3] = u[2] - 2 * n),
            hx(this, 'afterGetCenter', { positions: u }),
            u
          )
        }),
          (t.getStartAndEndRadians = function (t, e) {
            let i = hy(t) ? t : 0,
              s = hy(e) && e > i && e - i < 360 ? e : i + 360
            return { start: hm * (i + -90), end: hm * (s + -90) }
          })
      })(f || (f = {}))
      let hk = f,
        { setAnimation: hw } = tz,
      ...
      class hL extends oW {
        ...
        constructor (t, e, i) {
          ...
          hM(this, 'select', s), hM(this, 'unselect', s)
        }
        isValid () {
        ...
        slice (t, e, i) {
          ...
          hw(i, s.chart),
            (e = hA(e, !0)),
            (this.sliced = this.options.sliced = t = hS(t) ? t : !this.sliced),
      ...
      let { getStartAndEndRadians: hO } = hk,
        { noop: hE } = k,
        { clamp: hI, extend: hD, fireEvent: hB, merge: hN, pick: hz } = $
      class hR extends rX {
        animate (t) {
          let e = this,
            i = e.points,
          ...
          t ||
            i.forEach(function (t) {
              ...
              i &&
                o &&
                (i.attr({
                  r: hz(t.startR, e.center && e.center[3] / 2),
                  start: s,
                  end: s
                }),
                i.animate(
            ...
            ? ((t = this.center[0]),
              ...
              this.graph ||
                (this.graph = this.chart.renderer
                  ...
                  .add(this.group)),
              this.graph.attr({
                d: e2.arc(t, e, this.center[2] / 2, 0, {
                  start: i,
                  end: s,
        ...
        translate (t) {
          hB(this, 'translate'), this.generatePoints()
          let e = this.options,
            i = e.slicedOffset,
            s = hO(e.startAngle, e.endAngle),
      ...
      ;(hR.defaultOptions = hN(rX.defaultOptions, {
        borderRadius: 3,
        center: [null, null],
        clip: !1,
        colorByPoint: !0,
        ...
        hD(hR.prototype, {
          ...
          directTouch: !0,
          drawGraph: void 0,
          drawTracker: n_.prototype.drawTracker,
          getCenter: hk.getCenter,
          getSymbol: hE,
          invertible: !1,
          isCartesian: !1,
          noSharedTooltip: !0,
          pointAttribs: n_.prototype.pointAttribs,
          pointClass: hL,
          requireSorting: !1,
          searchPoint: hE,
          trackerGroups: ['group', 'dataLabelsGroup']
        }),
        rn.registerSeriesType('pie', hR)
      let { composed: hW, noop: hH } = k,
        { distribute: hX } = en,
        { series: hF } = rn,
        {
          arrayMax: hG,
      ...
      !(function (t) {
        ...
        function s () {
          ...
          t.visible &&
            ...
            hF.prototype.drawDataLabels.apply(t),
            e.forEach(t => {
                  ...
                  ;(i.dataLabels || []).forEach(l => {
                    ...
                    if (x) {
                      ...
                      if (
                        ...
                        let t
                        w - (g = l.getBBox().width) < b && 1 === a
                          ? ((t = Math.round(g - w + b)),
                            (c[3] = Math.max(t, c[3])))
                          : w + g > s - b &&
                            0 === a &&
                            ((t = Math.round(w + g - s + b)),
                            (c[1] = Math.max(t, c[1]))),
                          M - f / 2 < 0
            ...
            (0 === hG(c) || this.verifyDataLabelOverflow(c)) &&
                    ...
                    ;(u = s.connector),
                      a && a.distance > 0
                        ? ((n = !u),
                          ...
                          u.attr({ visibility: a.attribs?.visibility }))
            ...
            !a &&
              (null !== s[0]
                ...
                : ((r = Math.max(e[2] - t[1] - t[3], o)),
                  (e[0] += (t[3] - t[1]) / 2)),
              null !== s[1]
                ? (r = hY(r, o, e[2] - Math.max(t[0], t[2])))
                : ((r = hY(r, o, e[2] - t[0] - t[2])),
                  (e[1] += (t[0] - t[2]) / 2)),
              r < e[2]
                ? ((e[2] = r),
                  (e[3] = Math.min(
        ...
        t.compose = function (t) {
          if ((ht.compose(hF), h$(hW, 'PieDataLabel'))) {
            let a = t.prototype
      ...
      let { pointInPolygon: hZ } = x,
        { addEvent: h_, fireEvent: hK, objectEach: hJ, pick: hQ } = $
      function h0 (t) {
        let e = t.length,
          i = (t, e) =>
            !(
          ...
          s = (t, e) => {
            for (let i of t) if (hZ({ x: i[0], y: i[1] }, e)) return !0
            return !1
          },
          o,
          r,
        ...
        for (let e of t) h1(e, this) && (l = !0)
        l && hK(this, 'afterHideAllOverlappingLabels')
      }
      function h1 (t, e) {
        let i,
          s,
            ...
            t.oldOpacity !== s &&
              (t.hasClass('highcharts-data-label')
                ? (t[s ? 'removeClass' : 'addClass'](
                  ...
                  hK(e, 'afterHideOverlappingLabel'))
                : t.attr({ opacity: s })),
            (t.isOld = !0)),
          o
        )
      ...
      let h3 = {
          compose: function (t) {
            ...
            e.hideOverlappingLabels ||
              ((e.hideOverlappingLabels = h0), h_(t, 'render', h2))
          }
        },
        { defaultOptions: h5 } = tf,
        { noop: h6 } = k,
        {
          addEvent: h9,
          extend: h4,
        ...
        le = { radius: 0, scope: 'stack', where: void 0 },
        li = h6,
        ls = h6
      ...
      function lr () {
        if (
          ...
          let { options: t, yAxis: e } = this,
            ...
            s = h5.plotOptions?.[this.type]?.borderRadius,
            o = la(t.borderRadius, h8(s) ? s : {}),
          ...
          for (let s of this.points) {
            ...
            if ('roundedRect' === s.shapeType && a) {
              ...
              !u &&
                ...
                u || (u = 'end')
              let g =
                Math.min(lt(o.radius, n), n / 2, 'all' === u ? h / 2 : 1 / 0) ||
                0
              'end' === u && (p && (d -= g), (c += g)),
                h4(a, { brBoxHeight: c, brBoxY: d, r: g })
            }
          }
        }
      }
      function la (t, e) {
        return h8(t) || (t = { radius: t || 0 }), h7(le, e, t)
      }
      function ln () {
        let t = la(this.options.borderRadius)
        for (let e of this.points) {
          let i = e.shapeArgs
          i && (i.borderRadius = lt(t.radius, (i.r || 0) - (i.innerR || 0)))
        }
      }
      function lh (t, e, i, s, o = {}) {
        let r = ls(t, e, i, s, o),
      ...
      !(function (t) {
        function e (t, e) {
          ...
          ;(
            ...
            function () {
              return (
                this.chartWidth <= lu(i.maxWidth, Number.MAX_VALUE) &&
                this.chartHeight <= lu(i.maxHeight, Number.MAX_VALUE) &&
                this.chartWidth >= lu(i.minWidth, 0) &&
                this.chartHeight >= lu(i.minHeight, 0)
              )
            }
        ...
        function i (t, e) {
          ...
          !e &&
            ...
            i.rules &&
            i.rules.forEach(t => {
              void 0 === t._id && (t._id = lg()), this.matchResponsiveRule(t, o)
            }, this)
          let a = lp(
            ...o
              .map(t => lc((i || {}).rules || [], e => e._id === t))
        ...
        t.compose = function (t) {
          ...
          return (
            s.matchResponsiveRule ||
              ld(s, { matchResponsiveRule: e, setResponsive: i }),
            t
          )
        }
      })(y || (y = {}))
      ...
      ;(k.AST = t_),
        ...
        (k.Legend = r7),
        (k.LegendSymbol = ri),
        (k.OverlappingDataLabels = k.OverlappingDataLabels || h3),
        (k.PlotLineOrBand = s5),
        (k.Point = oW),
        (k.Pointer = o3),
        (k.RendererRegistry = ei),
        (k.Series = rX),
        (k.SeriesRegistry = rn),
        (k.StackItem = a6),
        (k.SVGElement = eF),
        ...
        (k.Time = tl),
        (k.Tooltip = oy),
        (k.animate = tz.animate),
        (k.animObject = tz.animObject),
        (k.chart = aH.chart),
        (k.color = tv.parse),
        (k.dateFormat = ee.dateFormat),
        (k.defaultOptions = tf.defaultOptions),
        (k.distribute = en.distribute),
        (k.format = ee.format),
        (k.getDeferredAnimation = tz.getDeferredAnimation),
        (k.getOptions = tf.getOptions),
        (k.numberFormat = ee.numberFormat),
        (k.seriesType = rn.seriesType),
        (k.setAnimation = tz.setAnimation),
        (k.setOptions = tf.setOptions),
        (k.stop = tz.stop),
        (k.time = tf.defaultTime),
        (k.timers = tT.timers),
        {
          compose: function (t, e, i) {
            ...
            if (!e.symbolCustomAttribs.includes('borderRadius')) {
              ...
              h9(t, 'afterColumnTranslate', lr, { order: 9 }),
                h9(s, 'afterTranslate', ln),
        ...
        ha.compose(k.Series.types.column),
        ht.compose(k.Series),
        sH.compose(k.Axis),
        iV.compose(k.SVGRenderer),
        r7.compose(k.Chart),
        sY.compose(k.Axis),
        h3.compose(k.Chart),
        hq.compose(k.Series.types.pie),
        s5.compose(k.Chart, k.Axis),
        o3.compose(k.Chart),
        lf.compose(k.Chart),
        aK.compose(k.Axis, k.Chart, k.Series),
        nf.compose(k.Axis, k.Chart, k.Series),
        oy.compose(k.Pointer),
        $.extend(k, $)
      let lm = k
      return v.default
    })()
