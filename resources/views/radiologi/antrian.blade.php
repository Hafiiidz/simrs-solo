                ...
                <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                    ...
                    <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
                            ...
                            <!--end::Item-->
                            <!--begin::Item-->
                            <li class="breadcrumb-item text-muted">Antrian Radiologi</li>
                            <!--end::Item-->
                        </ul>
                        <!--end::Breadcrumb-->
                    </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">
                            <h5 class="card-title">Antrian Radiologi</h5>
                        </div>
                        ...
                        <table id="tbl-pasien" class="table table-striped gy-5 gs-7  rounded">
                            <thead class="">
                                <tr class="text-center">
                                    <th>
                                        <input type="text" class="form-control form-control-sm" name='no_rm' id='no_rm' placeholder="NO RM" />
                                    </th>
                                    <th>
                                        <input type="text" class="form-control form-control-sm" name='nama_pasien' id='nama_pasien' placeholder="nama_pasien" />
                                    </th>
                                    <th></th>
                                    <th></th>
                                    <th>
