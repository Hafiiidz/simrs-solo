            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex align-items-stretch">
                ...
                <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                    ...
                    <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                        <!--begin::Title-->
                        <h1 class="page-heading d-flex flex-column justify-content-center text-dark fw-bold fs-3 m-0">Create
                            BHP OK</h1>
                        <!--end::Title-->
                        <!--begin::Breadcrumb-->
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">
                            <h5 class="card-title">Create Bph OK</h5>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <form action="" method="POST" id='frmcreatebhp'>
                                    @csrf
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">Nama BHP</label>
                                        <input type="text" class="form-control" required id="exampleFormControlInput1" name="nama_barang"
...
@section('js')
    ...
    <script>
        ...
        $(function() {
            $("#frmcreatebhp").submit(function(e) {
                e.preventDefault();
                var form = $(this);
                $.ajax({
                    url: "{{ route('store.bhp') }}",
