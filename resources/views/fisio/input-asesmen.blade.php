                                    ...
                                    <div class="card-body">
                                                ...
                                                <div class="d-flex justify-content-start">
                                                    <div class="form-check form-check-custom form-check-solid">
                                                        <input class="form-check-input" type="radio" value="Autoanamnese"
                                                            id="riwayat-1" checked name="anamnese">
                                                    ...
                                                    <div class="form-check form-check-custom form-check-solid">
                                                        <input class="form-check-input" type="radio"
                                                            value="Heteroanamnese" id="riwayat-1" name="anamnese">
                                                        <label class="form-check-label" for="flexRadioDefault">
                                                            Heteroanamnese
                                                        </label>
                                                    </div>
                                        ...
                                        <div class="row mb-5">
                                            <div class="col-md-12">
                                                ...
                                                <textarea required name="keluhan_utama" required id="" class="form-control" rows=3></textarea>
                                            </div>
                                        </div>
                                        <div class="row mb-5">
                                            <div class="col-md-12">
                                                <label class="form-label">Riwayat Penyakit Dahulu dan Penyerta</label>
                                                <textarea required name="riwayat_penyakit" required id="" class="form-control" rows=3></textarea>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row md-5">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group mb-5">
                                                    <input type="text" class="form-control" onkeyup="calculateBMI()"
                                                        id="berat_badan_val" name="berat_badan" value=""
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group mb-5">
                                                    <input type="text" class="form-control" onkeyup="calculateBMI()"
                                                        id="tinggi_badan_val" name="tinggi_badan" value=""
                                        ...
                                        <div class="row col-md-4">
                                            ...
                                            <div class="input-group mb-5">
                                                <input type="text" class="form-control" id="bmi_val" name="bmi"
                                                    value="NaN" placeholder="...." aria-label="....e"
                                        ...
                                        <div class="row mb-5">
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" class="form-control" name="skor_nyeri">
                                            </div>
                                            <div class="col-md-4">
                                                <label class="form-label">Berkurang Saat</label>
                                                <input type="text" class="form-control" name="berkurang">
                                            </div>
                                            <div class="col-md-4">
                                                <label class="form-label">Bertambah Saat</label>
                                                <input type="text" class="form-control" name="bertambah">
                                            </div>
                                        </div>
                                        <div class="separator separator-dashed border-secondary mb-5"></div>
                                        <div class="row mb-5">
                                            ...
                                            <div class="col-md-3">
                                                <div class="d-flex justify-content-start">
                                                    <div class="form-check form-check-custom form-check-solid">
                                                        <input class="form-check-input" checked type="radio" value="0"
                                        ...
                                        <div class="row mb-5">
                                            <div class="col-md-12">
                                                ...
                                                <textarea required name="pemeriksaan_umum" id="" class="form-control" rows=3></textarea>
                                            </div>
                                        </div>
                                        <div class="row mb-5">
                                            <div class="col-md-12">
                                                ...
                                                <textarea required name="pemeriksaan_khusus" id="" class="form-control" rows=3></textarea>
                                            </div>
                                        </div>
                                        <div class="row mb-5">
                                            <div class="col-md-12">
                                                <label class="form-label">Pemeriksaan Penunjang : (Radiologi, EKG, Lab,
                                                    EMG,dll)</label>
                                                <textarea required name="pemeriksaan_penunjang" id="" class="form-control" rows=3></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card card-bordered">
                                    <div class="card-body">
                                        <div class="col-md-12">
                                            ...
                                            <textarea required name="diagnosis_fisio" id="" class="form-control" rows=3></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="col-md-12">
                                            <label class="form-label">Program/Rencana Terapi : (Tujuan, Modalitas,
                                                Frekuensi)</label>
                                            <textarea required name="program_rencana" id="" class="form-control" rows=5></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card card-bordered">
                                    <div class="card-body">
                                        <div class="col-md-12">
                                            ...
                                            <textarea required name="evaluasi" id="" class="form-control" rows=5></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
