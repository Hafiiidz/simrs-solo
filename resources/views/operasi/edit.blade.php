            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-toolbar">
                        <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal"data-bs-target="#modal_status">Ubah Status</button>
                        &nbsp;
                        ...
                        <form id="frm-data" action="{{ route('update.operasi', $data->id) }}" method="POST" autocomplete="off">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control" placeholder="Pilih Tanggal Operasi" id="tgl_operasi" name="tgl_operasi" value="{{ $data->tgl_operasi }}" required/>
                                </div>
                                <div class="col-md-3">
                                    <label for="" class="form-label">Jam Mulai</label>
                                    <input class="form-control" placeholder="Pilih Jam Mulai" id="mulai_jam" name="mulai_jam" value="{{ $data->mulai_jam }}" required/>
                                </div>
                                <div class="col-md-3">
                                    <label for="" class="form-label">Jam Selesai</label>
                                    <input class="form-control" placeholder="Pilih Jam Mulai" id="selesai_jam" name="selesai_jam" value="{{ $data->selesai_jam }}" required/>
                                </div>
                                <div class="col-md-3">
                                    <label for="" class="form-label">Lama Operasi</label>
                                    <input class="form-control" type="text" placeholder="Masukan Lama Operasi" id="lama_operasi" name="lama_operasi" value="{{ $data->lama_operasi }}" required/>
                                </div>
                            </div>
                            <div class="row mt-5">
                                <div class="row">
                                                            ...
                                                            <div data-repeater-item>
                                                                <div class="form-group row mb-5">
                                                                    <div class="col-md-10">
                                                                        ...
                                                                        <input type="text" name="dokter_bedah" class="form-control mb-2 mb-md-0" placeholder="Masukan Nama" value="{{ $val->dokter_bedah }}" />
                                                                    </div>
                                                                    <div class="col-md-2">
                                                    ...
                                                    @else
                                                        <div data-repeater-item>
                                                            <div class="form-group row mb-5">
                                                                <div class="col-md-10">
                                                                    <label class="form-label">Dokter Bedah</label>
                                                                    <input type="text" name="dokter_bedah" class="form-control mb-2 mb-md-0" placeholder="Masukan Nama" />
                                                                </div>
                                                                <div class="col-md-2">
                                                                    <a href="javascript:;" data-repeater-delete class="btn btn-sm btn-light-danger mt-3 mt-md-8">
                                                                        <i class="ki-duotone ki-trash fs-5"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span><span class="path5"></span></i>
                                                            ...
                                                            <div data-repeater-item>
                                                                <div class="form-group row mb-5">
                                                                    <div class="col-md-10">
                                                                        ...
                                                                        <input type="text" name="perawat_bedah" class="form-control mb-2 mb-md-0" placeholder="Masukan Nama" value="{{ $val->perawat_bedah }}" />
                                                                    </div>
                                                                    <div class="col-md-2">
                                                                        <a href="javascript:;" data-repeater-delete class="btn btn-sm btn-light-danger mt-3 mt-md-8">
                                                                            <i class="ki-duotone ki-trash fs-5"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span><span class="path5"></span></i>
                                                    ...
                                                    @else
                                                        <div data-repeater-item>
                                                            <div class="form-group row mb-5">
                                                                <div class="col-md-10">
                                                                    <label class="form-label">Perawat Bedah</label>
                                                                    <input type="text" name="perawat_bedah" class="form-control mb-2 mb-md-0" placeholder="Masukan Nama" />
                                                                </div>
                                                                <div class="col-md-2">
                                                                    <a href="javascript:;" data-repeater-delete class="btn btn-sm btn-light-danger mt-3 mt-md-8">
                                                                        <i class="ki-duotone ki-trash fs-5"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span><span class="path5"></span></i>
                                                            ...
                                                            <div data-repeater-item>
                                                                <div class="form-group row mb-5">
                                                                    <div class="col-md-10">
                                                                        ...
                                                                        <input type="text" name="asisten" class="form-control mb-2 mb-md-0" placeholder="Masukan Nama" value="{{ $val->asisten }}" />
                                                                    </div>
                                                                    <div class="col-md-2">
                                                                        <a href="javascript:;" data-repeater-delete class="btn btn-sm btn-light-danger mt-3 mt-md-8">
                                                                            <i class="ki-duotone ki-trash fs-5"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span><span class="path5"></span></i>
                                                    ...
                                                    @else
                                                        <div data-repeater-item>
                                                            <div class="form-group row mb-5">
                                                                <div class="col-md-10">
                                                                    <label class="form-label">Asisten</label>
                                                                    <input type="text" name="asisten" class="form-control mb-2 mb-md-0" placeholder="Masukan Nama" />
                                                                </div>
                                                                <div class="col-md-2">
                                                                    <a href="javascript:;" data-repeater-delete class="btn btn-sm btn-light-danger mt-3 mt-md-8">
                                                                        <i class="ki-duotone ki-trash fs-5"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span><span class="path5"></span></i>
                            ...
                            <div class="row mt-5">
                                <div class="col-md-12">
                                    ...
                                    <select name="jenis_operasi" class="form-select" data-control="select2" data-placeholder="Pilih Jenis Operasi">
                                        <option></option>
                            ...
                            <div class="row mt-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="kamar_operasi" id="kamar_operasi" class="form-control" placeholder="Masukan Kamar Operasi" value="{{ $data->kamar_operasi }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row mt-5">
