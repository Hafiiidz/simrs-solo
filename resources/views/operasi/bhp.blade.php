                                            ...
                                            @foreach ($bhp as $key => $item)
                                                @php
                                                    $cek_bhp = DB::table('operasi_tindakan_bhp')
                                                        ...
                                                        ->where('idtindakan', $operasi_tindakan->idtindakan)
                                                        ->first();
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="hidden" name="bhp[{{ $key }}][id]"
                                                            value="{{ $item->id }}">
                                                        <input type="hidden" name="bhp[{{ $key }}][satuan]"
                                                            value="{{ $item->satuan }}">
                                                        <input type="hidden" name="bhp[{{ $key }}][harga]"
                                                            value="{{ $item->harga }}">
                                                        <input type="hidden" name="bhp[{{ $key }}][nama]"
                                                            value="{{ $item->nama_barang }}">
                                                        <input type="text" name="bhp[{{ $key }}][jumlah]"
                                            ...
                                            @foreach ($implan as $key2 => $item2)
                                                ...
                                                <tr>
                                                    ...
                                                    <input type="hidden" name="implan[{{ $key }}][nama]" value="{{ $item2->nama }}"> --}}
                                                        <input type="text" name="implan[{{ $key2 }}][jumlah]"
                                                            class="form-control form-control-sm"
                                                            value="{{ $cek_implan->jumlah ?? null }}">
                                                    </td>
                                                    <td>{{ $item2->satuan }}</td>
