        ...
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex align-items-stretch">
            ...
            <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                ...
                <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex flex-column justify-content-center text-dark fw-bold fs-3 m-0">Antrian Resep</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                            ...
                            <a href="{{ route('farmasi.status-ranap',$rr->idrawat) }}">
                                <div class="rounded border mb-2 bg-light-info"> 
                                    ...
                                    <div class="row p-2">
                                        ...
                                        <div class="col-md-8">
                                            <span class="md-bold fs-6 text-gray-800">{{ $rr->rawat->ruangan->nama_ruangan }}</span>
                                        </div>                                    
                                        <!--end::Col-->
                                    </div>
                                    <div class="row p-2">
